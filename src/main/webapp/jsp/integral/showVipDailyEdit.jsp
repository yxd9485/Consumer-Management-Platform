...
<div class="container">
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li class="current"><a title="">修改会员日常任务</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath %>/integral/doVipDailyEdit.do">
                <input type="hidden" name="queryParam" value="${queryParam}"/>
                <input type="hidden" name="pageParam" value="${pageParam}"/>
                <input type="hidden" name="infoKey" value="${vpsVipDailyTaskCog.infoKey}"/>
                <div class="widget box">
                    <div class="widget-header">
                        <h4><i class="iconfont icon-xinxi"></i>会员日常任务修改</h4>
                    </div>
                    <div class="widget-content panel no-padding">
                        <table class="active_board_table">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <input name="startDate" id="startDate"
                                               ...
                                               tag="validate" autocomplete="off" value="${vpsVipDailyTaskCog.startDate}"
                                        ...
                                        <input name="endDate" id="endDate"
                                               ...
                                               tag="validate" autocomplete="off" value="${vpsVipDailyTaskCog.endDate}"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <select name="taskType" disabled class="form-control required input-width-large search">
                                            <option value="">请选择</option>
                                            <c:forEach items="${taskTypeMap}" var="item">
                                                <option value="${item.key}" <c:if test="${vpsVipDailyTaskCog.taskType eq item.key}">selected</c:if>> ${item.value}</option>
                                            </c:forEach>
                                        </select>
                                        <label class="validate_tips"></label>
                                    </div>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="vpointsCog" tag="validate"
                                               class="form-control required positive number minValue maxValue" value="${vpsVipDailyTaskCog.vpointsCog}"
