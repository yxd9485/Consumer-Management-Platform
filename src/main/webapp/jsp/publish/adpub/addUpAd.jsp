    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath %>/adPub/doAdUpAdd.do">
                <div class="widget box">
                    <div class="widget-header">
                        <h4><i class="iconfont icon-xinxi"></i>新增弹窗广告</h4>
                    </div>
                    <div class="widget-content panel no-padding">
                        <table class="active_board_table">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <c:if test="${currentUser.projectServerName ne 'qinghuafj' && currentUser.projectServerName ne 'laobaifj' && currentUser.projectServerName ne 'zhongliang' && currentUser.projectServerName ne 'hgquqi' && currentUser.projectServerName ne 'yuyuan' && currentUser.projectServerName ne 'zhongLCNY' && currentUser.projectServerName ne 'yinlu' && currentUser.projectServerName ne 'quechao' && currentUser.projectServerName ne 'zhongLJH' && currentUser.projectServerName ne 'mengniu' && currentUser.projectServerName ne 'mengniuzhi' && currentUser.projectServerName ne 'zhongLFQ' }">
	                                        <input type="radio" name="adLoc" value="5" class="tab-radio"
	                                               style="float:left;"/>
                            ...
                            <tr>
                                ...
                                <td class="ab_main sku" colspan="3">
                                    <div class="content sku promotionSku" style="display: flex; margin: 5px 0px;">
                                        <select class="form-control input-width-larger required" id="skuKey"
                                                name="skuKey" tag="validate">
                                            <option value="">请选择SKU</option>
                                            <c:if test="${!empty skuList}">
                                                <c:forEach items="${skuList}" var="sku">
                                                    <option value="${sku.skuKey}"
                                                            data-img="${sku.skuLogo}">${sku.skuName}</option>
                                                </c:forEach>
                                            </c:if>
                                        </select>
                            ...
                            <%--限定热区--%>
                            <tr id="hotAreaTrId" style="display: none" >
...
<%--                                        <label class="validate_tips title mart5 btn-txt-add-red"--%>
<%--                                               style="font-weight: normal; margin-left: 5px;" id="addArea">新增</label>--%>
<%--                                        <label class="validate_tips"></label>--%>
<%--                                    </div>--%>
<%--                                </td>--%>
...
<%--                            </tr>--%>
                            <tr>
                                <td class="ab_left"><label class="title">展示日期：<span class="required">*</span></label>
                                </td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="pubStat" type="hidden" value="1"/>
                                        <input id="pubStat" type="checkbox" checked data-size="small" data-on-text="启用"
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="frontDelayed"  id="frontDelayed" tag="validate"
                                               class="form-control required number minValue maxValue" style="width: 500px;" autocomplete="off" maxlength="30" minVal="0.00" maxVal="5.00"/>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input tag="validate" name="popNum" tag="validate"
                                               class="form-control" style="width: 500px;" autocomplete="off" maxlength="100" placeholder = "空表示不限制" />
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div tag="validate" class="content">
                                        <input name="sequenceno" tag="validate"
                                               class="form-control input-width-small required" autocomplete="off" maxlength="2" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="ab_left"><label class="title">弹窗关闭方式：<span class="required">*</span></label>
                                </td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="closeType" value="1"
                                               style="float:left;" checked="checked"/>
                                        <span class="blocker en-larger" style="margin-left: 2px;">手动关闭</span>
                                        <input type="radio" class="tab-radio" name="closeType" value="2"
                                               style="float:left; margin-left: 10px !important;"/>
                                        <span class="blocker en-larger" style="margin-left: 2px;">自动关闭</span>
                                        <select name="closeTime" class="form-control required" tag="validate"
                                                disabled="disabled" autocomplete="off" style="width: 90px;"/>
                                        <option value="3">3秒(默认)</option>
                                        <option value="1">1秒</option>
                                        <option value="2">2秒</option>
                                        <option value="4">4秒</option>
                                        <option value="4">5秒</option>
                                        </input>
                                        <label class="validate_tips"></label>
                                        </select>
                                    </div>
                            ...
                            <tr>
                                <td class="ab_left"><label class="title">重复扫码是否弹出广告：<span
                                        class="required">*</span></label></td>
                                <td class="ab_main" colspan="3">
                                    <div class="content" >
                                        <input id="repeateCodeShow" type="radio" name="repeateCodeShow" value="1" class="tab-radio"
                                               checked="checked" style="float:left;"/>
                                        <span class="blocker en-larger" style="margin-left: 2px;">否</span>
                                        <input id="repeateCodeShow1" type="radio" name="repeateCodeShow" class="tab-radio" value="2"
                                               style="float:left;"/>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <div class="item">
                                            <a href="<%=cpath %>/picLib/picLibList.do?vjfSessionId=${vjfSessionId}&group=8"
                                                 target= "my_iframe" class="addImg1"  onclick="clickImg('picUrl');" style="z-index: 3;
    opacity: 0;"></a>
                                            <img class="addImg1" id="picUrl"
                                                 src="<%=cpath %>/inc/vpoints/img/a12.png" width="20" height="20"/>
                            ...
                            <tr>
                                <input name="picWidth" tag="validate"
                                       class="form-control required" autocomplete="off" maxlength="10" placeholder="宽"
                                       type="hidden"/>
                                <input name="picHeight" tag="validate"
                                       class="form-control required" autocomplete="off" maxlength="10" placeholder="高"
                                       type="hidden"/>
                                <input name="picX" tag="validate"
                                       class="form-control required" autocomplete="off" maxlength="10" placeholder="坐标x"
                                       type="hidden"/>
                                <input name="picY" tag="validate"
                                       class="form-control required" autocomplete="off" maxlength="10" placeholder="坐标y"
                                       type="hidden"/>
                            </tr>
                            ...
                            <tr>
                                <td class="ab_left" style="display: none"><label class="title"></label></td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="resolution" tag="validate"
                                               class="form-control " autocomplete="off" maxlength="200"
                                               style="display: none"/>
                                    </div>
                                </td>
                            </tr>
...
<%--                            <button class="btn btn-red btnSave">预览</button>&nbsp;&nbsp;&nbsp;&nbsp;--%>
                            <button class="btn btnReturn btn-radius3" data-url="<%=cpath%>/adPub/showAdUpList.do">返 回
                            </button>
                        </div>
                    </div>
                </div>
