    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
            	action="<%=cpath %>/adPub/adHomeEdit.do">
            	<div class="widget box">
            		<div class="widget-header">
            			<h4><i class="iconfont icon-xinxi"></i>修改首页广告</h4>
            		</div>
                	<div class="widget-content panel no-padding">
                		<table class="active_board_table">
                			<tr style="display:none">
	                       		<td class="ab_left"><label class="adHomeKey"><span class="required">*</span></label></td>
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name=adHomeKey tag="validate"
	                       					class="form-control required" autocomplete="off" maxlength="30" value = "${vpsAdPub.adHomeKey}" />
	                       			</div>
	                       		</td>
	                       	</tr>
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="sequenceNo" tag="validate"
	                       					class="form-control required" autocomplete="off" maxlength="2" value = "${vpsAdPub.sequenceNo}"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" style="width: 120px;"/>
	                       				<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
	                       	</tr>
