    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
            	action="<%=cpath %>/actRegion/doAdRegionAdd.do">
            	<div class="widget box">
            		<div class="widget-header">
            			<h4><i class="iconfont icon-xinxi"></i>新增活动专区</h4>
            		</div>
                	<div class="widget-content panel no-padding">
                		<table class="active_board_table">
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" name="position" value="0" checked="checked"/>首页
                                        <input type="radio" name="position" value="1" />商城
                                        <input type="radio" name="position" value="2" />任务
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <select name="sectionGroup" id="sectionGroup" class = "form-control input-width-medium required" tag="validate">
                                            <option value="0" selected>热门活动</option>
                                            <option value="1" >京东商城</option>
                                            <option value="2" >冻鲜荟</option>
                                            <option value="3" >沃尔玛</option>
                                            <option value="4" >小象超市</option>
                                        </select>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <label class="blocker en-larger" style="margin-left: 2px;"><input name="crowdLimitType" type="radio" value='1'/>黑名单及可疑用户不可领取</label>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="sequenceNo" tag="validate"
                                               class="form-control required" autocomplete="off" maxlength="2" style="width: 120px;"/>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr id = "picJumpUrlTr" style="display:none">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <div class="item">
                                            <a href="<%=cpath %>/picLib/picLibList.do?vjfSessionId=${vjfSessionId}&group=16"  target= "my_iframe" class="addImg1"  onclick="clickImg('picJumpUrl');" style="z-index: 3;opacity: 0;"></a>
                                            <img class="addImg1" id="picJumpUrl" src="<%=cpath %>/inc/vpoints/img/a12.png" width="20" height="20" />
                            ...
                            <tr id = "canDoubleJump" style="display:none">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <label class="blocker en-larger" style="margin-left: 2px;"><input name="canDoubleJump" type="radio" value='0' checked="checked"/>否</label>
