	...
	<script>
		$(function(){
			...
			$("#addItem").click(function(){
				var url = "<%=cpath%>/adPub/showAdHomeAdd.do";
			...
			$("a.edit").on("click", function(){
				...
				var url = "<%=cpath%>/adPub/showAdHomeEdit.do?adHomeKey="+key;
				$("form").attr("action", url);
				$("form").submit(); 
			});
			// 编辑
			...
			$("a.del").on("click", function(){
				var key = $(this).parents("td").data("key");
				var url = "<%=cpath%>/adPub/adHomeDelete.do?adHomeKey="+key;
            ...
            <div class="widget box">
	            <div class="row">
                   ...
                   <!-- 用户key不为空 ne -->
                           <a id="addItem" class="btn btn-blue">
                               <i class="iconfont icon-tianjiajiahaowubiankuang" style="font-size: 12px;"></i>&nbsp; 新建轮播图
                           </a>
                   </div>
	            </div>
	            ...
	            <!--查询url  -->
		            <form class="listForm" method="post"
	                    action="<%=cpath%>/adPub/showHomeAdList.do">
                        ...
                        <table class="table table-checkable table-striped table-hover table-bordered plus_end plus_top dt_table mart10"
					        ...
					        <tbody>
					        	...
					        	<tr>
					        		...
					        		<td data-key="${item.adHomeKey}" style="text-align: center;">
