    ...
    <script>
        ...
        function initPage() {
            ...
            $(".btnSave").on("click", function(){
                ...
                // 提交表单
                var url = "<%=cpath%>/seckillActivity/doSeckillActivityEdit.do";
                $.ajax({
                    type: "POST",
                    url: url,
                    data: paramJson,
                        ...
                        <div class="widget-content panel no-padding">
                            <table class="active_board_table">
                        		...
                        		<td class="ab_main">
                        			<div class="content">
                        			    <select name="ruleType" class="form-control input-width-medium">
	                                            ...
	                                            <option value="2" <c:if test="${activityCog.ruleType eq '2'}"> selected="selected" </c:if>>周几</option>
                        			    </select>
                        			</div>
                        		</td>
                        	</tr>
	                			...
	                			<tr>
	                        		...
	                        		<td class="ab_main time">
	                        			<div class="content time" style="margin: 5px 0px;">
	                                        <input name="beginTime" id="beginTime0" class="form-control input-width-medium Wdate" tag="validate" value="${activityCog.beginTime }" 
	                                        onfocus="WdatePicker({dateFmt:'HH:mm:ss', maxDate:'#F{$dp.$D(\'endTime0\')}'})" value="00:00:00" autocomplete="off"/>
	                                        <span class="blocker en-larger">至</span>
	                                        <input name="endTime" id="endTime0" class="form-control input-width-medium Wdate" tag="validate" value="${activityCog.endTime }"
                                ...
                                <tr>
		                       		...
		                       		<td class="ab_main" colspan="3">
		                       			<div class="content">
		                       				<input name="seckillPay" tag="validate" value="${activityCog.seckillPay }"
		                       	...
		                       	<tr>
		                       		...
		                       		<td class="ab_main" colspan="3">
		                       			<div class="content">
		                       				<input name="seckillVpoints" tag="validate"  value="${activityCog.seckillVpoints }"
                                ...
                                <tr>
		                       	...
		                       	<tr>
		                       		...
		                       		<td class="ab_main" colspan="3">
		                       			<div class="content">
		                       				<input name="seckillPeriodsNum" tag="validate" value="${activityCog.seckillPeriodsNum }" 
		                       					class="form-control required integer input-width-small rule" autocomplete="off" maxlength="9" />
		                       				<span class="blocker en-larger">件</span>
		                       				<label class="validate_tips"></label>
		                       			</div>
		                       	...
		                       	<tr>
		                       		...
		                       		<td class="ab_main" colspan="3">
		                       			<div class="content">
		                       				<input name="seckillTotalNum" tag="validate" value="${activityCog.seckillTotalNum }" disabled="disabled"
		                       					class="form-control required integer input-width-small rule" autocomplete="off" maxlength="9" />
		                       				<span class="blocker en-larger">件</span>
		                       				<label class="validate_tips"></label>
		                       			</div>
		                       		...
		                       		<td class="ab_main" colspan="3">
		                       			<div class="content">
	                        			    <select name="unpaidOrderTime" class="form-control input-width-medium">
	                                            <option value="5" <c:if test="${activityCog.unpaidOrderTime eq '5' }"> selected="selected" </c:if>>5</option>
	                                            <option value="10" <c:if test="${activityCog.unpaidOrderTime eq '10' }"> selected="selected" </c:if>>10</option>
	                                            <option value="15" <c:if test="${activityCog.unpaidOrderTime eq '15' }"> selected="selected" </c:if>>15</option>
	                                            <option value="20" <c:if test="${activityCog.unpaidOrderTime eq '20' }"> selected="selected" </c:if>>20</option>
	                                            <option value="25" <c:if test="${activityCog.unpaidOrderTime eq '25' }"> selected="selected" </c:if>>25</option>
	                                            <option value="30" <c:if test="${activityCog.unpaidOrderTime eq '30' }"> selected="selected" </c:if>>30</option>
	                        			    </select>
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content">
                                        	<span class="blocker en-larger">
												<input name="isSeckillLimit" type="checkbox" value="${activityCog.isSeckillLimit }" <c:if test="${activityCog.isSeckillLimit eq '1'}"> checked="checked" </c:if>/>
											</span>
                                            <span class="blocker en-larger">开启</span>
                                            <span class="blocker en-larger">每人可购买</span>
                                            <input name="seckillLimitNum" class="form-control required integer input-width-small rule" autocomplete="off" maxlength="2" value="${activityCog.seckillLimitNum }" 
                                            	<c:if test="${activityCog.isSeckillLimit ne '1'}"> disabled="disabled" </c:if>/>
                                            <span class="blocker en-larger">件</span>
                                        </div>
                                    </td>
                                </tr>
