        ...
        <div class="col-md-12 tabbable tabbable-custom">
            <div class="widget box">
                ...
                <div class="widget-content panel no-padding">
					...
					<!-- 扫码活动 -->
                        <tr>
                            ...
                            <td class="ab_left"><label class="title">秒杀商品：<span class="required"></span></label></td>
                            <td class="ab_main" style="width: 5% !important;">
                                <div class="content">
                                    <span>${activityCog.goodsName}</span>
                                </div>
                            </td>
                            <td class="ab_left"><label class="title">秒杀价：<span class="required"></span></label></td>
                            <td class="ab_main" style="width: 5% !important;">
                                <div class="content">
                                    <span>${activityCog.seckillPay}</span>
                                </div>
                            </td>
                            <td class="ab_left"><label class="title">秒杀积分：<span class="required"></span></label></td>
                            <td class="ab_main" style="width: 5% !important;">
                                <div class="content">
                                    <span>${activityCog.seckillVpoints}</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <div class="content" style="width: 150px !important;">
                                    ...
                                    <c:choose>
                                    	<c:when test="${activityCog.ruleType eq '1' }">
                                    		<span>${activityCog.beginDate} ${activityCog.beginTime}</span></br>
                                    		<span>${activityCog.endDate} ${activityCog.endTime}</span>
                                    	</c:when>
                                    	<c:otherwise>
                                    		<span>周${activityCog.beginDate} ${activityCog.beginTime}</span></br>
                                    		<span>周${activityCog.endDate} ${activityCog.endTime}</span>
                                    	</c:otherwise>
                                    </c:choose>
                                </div>
                            </td>
               ...
               <!-- 活动信息 -->
                ...
                <div class="widget-content panel no-padding">
					...
					<!-- 扫码活动 -->
                        <tr>
                            <td class="ab_left" style="width: 5% !important;"><label class="title">每期库存：</label></td>
                            <td class="ab_main" style="width: 5% !important;">
                                <div class="content">
                                    <span>${empty(statistics.goodsRemains) ? '-' : statistics.goodsRemains}</span>
                                </div>
                            </td>
                            <td class="ab_left"><label class="title">秒杀总成交金额：<span class="required"></span></label></td>
                            <td class="ab_main" style="width: 5% !important;">
                                <div class="content">
                            ...
                            <td class="ab_main" style="width: 5% !important;">
                                <div class="content">
                                    <span><fmt:formatNumber value="${(empty(statistics.discountsMoney) ? 0 : (statistics.discountsMoney < 0 ? 0 : statistics.discountsMoney)) /100}" pattern="#,#0.00#"/></span>
                                </div>
                            </td>
                            <td class="ab_left"><label class="title">秒杀总成交积分：<span class="required"></span></label></td>
                            <td class="ab_main" style="width: 5% !important;">
                                <div class="content">
                        ...
                        <tr>
                            ...
                            <td class="ab_main" style="width: 5% !important;">
                                <div class="content">
                                    <span><fmt:formatNumber value="${empty(statistics.discountsVpoints) ? 0 : (statistics.discountsVpoints < 0 ? 0 : statistics.discountsVpoints)}" pattern="#,##0"/></span>
                                </div>
                            </td>
            ...
            <div class="row">
            	<div class="widget box" id="tab_1_1">
		    		<iframe id="ruleFrame" src="<%=cpath%>/vpointsExchange/showExchangeExpressList.do?vjfSessionId=${vjfSessionId}&tabsFlag=3&seckillActivityKey=${seckillActivityKey}" style="width: 100%;" scrolling="no" frameborder="no" border="0" onload="setIframeHeight()" on></iframe>
		    	</div>
		    </div>
        </div>
    </div>
