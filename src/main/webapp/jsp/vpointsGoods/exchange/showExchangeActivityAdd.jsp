    ...
    <script>
        ...
        function initPage() {
            ...
            $(".qrcodeUploadDialog, #goodsSelectRadioBtn").on("click", function () {
                ...
                $.ajax({
                    ...
                    success: function (datas) {
                        ...
                        if (datas.result.businessCode === '0') {
                            ...
                            if(reply.length == 0){
                                appendNullTd("goodsDetailsBody");
                                return
                            }
                            for (var index in reply) {
                                var goodsUrl = reply[index].goodsUrl;
                                goodsUrl = "<%=imagePath%>/" + reply[index].goodsUrl?.split(",")[0]
                                ...
                                $("#goodsDetailsBody").append('<tr>' +
                                    '<td class="text_center firstTd" style="vertical-align: middle;"><input type="radio" name="activityGoodsIdRaido" ' +
                                    inputType +
                                    ' value="' + reply[index].goodsId + '"></td>' +
                ...
                $("#addBtn").on("click", function () {
                    ...
                    if ("2" === $("#dialogType").val()) {
                        ...
                        for (let i = 0; i < goodsAllList.length; i++) {
                            ...
                            var goodsUrl = goodsAllList[i].goodsUrl;
                            goodsUrl = "<%=imagePath%>/" + goodsAllList[i].goodsUrl?.split(",")[0]
                            ...
                            $("#exchangeGoodsTable").append('<tr>' +
                                ...
                                '<input type="hidden" value="'+goodsAllList[i].goodsId+'" name="goodsIdList">' +
                                '</td>' +
                                '<td class="text_center" style="vertical-align: middle;">' + goodsAllList[i].goodsName + '</br><li style="color: red;list-style: none;">' + realMoney + '元</li></td>' +
                ...
                $("#goodsResetRadioBtn,#goodsResetCheckboxBtn").on("click", function () {
        ...
        function appendNullTd(tbid) {
            $("#"+tbid).append('<tr><td colspan="7" style="text-align: center"><span>查无数据！</span></td></tr>')
        }
  ...
  <body>
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" action="<%=cpath%>/exchangeActivity/exchangeActivitySave.do" class="form-horizontal row-border validate_form" id="code_form">
                                 ...
                                 <tr>
                                    ...
                                    <td class="ab_main" colspan="3">
										<div class="bottom-left">
                                            <a class="blue qrcodeUploadDialog" href="#">关联商品</a>
										</div>
                                    </td>
                                </tr>
                                 <tr>
