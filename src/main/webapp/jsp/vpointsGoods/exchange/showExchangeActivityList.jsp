	...
	<script>
		$(function(){
			...
			$("#addItem").click(function(){
				var url = "<%=cpath%>/exchangeActivity/showExchangeActivityAdd.do";
			...
			$("a.edit").on("click", function(){
				...
				var url = "<%=cpath%>/exchangeActivity/showExchangeActivityEdit.do?infoKey="+key;
				$("form").attr("action", url);
				$("form").submit(); 
			});
			// 数据
			...
			$("a.data").on("click", function(){
				var key = $(this).parents("td").data("key");
				var url = "<%=cpath%>/exchangeActivity/showExchangeDataList.do?infoKey="+key;
				$("form").attr("action", url);
				$("form").submit(); 
			});
			...
			$("a.del").on("click", function(){
				var key = $(this).parents("td").data("key");
				var url = "<%=cpath%>/exchangeActivity/delActivity.do";
            ...
            <div class="widget box">
	            ...
	            <div class="widget-content form-inline">
		            <form class="listForm" method="post"
	                    action="<%=cpath%>/exchangeActivity/showExchangeActivityList.do">
