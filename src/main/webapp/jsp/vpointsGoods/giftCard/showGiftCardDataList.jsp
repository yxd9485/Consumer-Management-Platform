	...
	<script>
		$(function(){
			...
			$("a.data").on("click", function(){
				var url = "<%=cpath%>/giftCardAction/importGiftCardActivityData.do";
				$("form").attr("action", url);
				$("form").submit();
                $("form").attr("action", "<%=cpath%>/giftCardAction/showGoodsGiftCardDataList.do");
			});
        });
	</script>
	<style>
  ...
  <body>
    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li class="current"><a> 礼品卡活动数据</a></li>
        ...
        <div class="col-md-12 tabbable tabbable-custom">
            <div class="widget box">
	            ...
	            <div class="widget-content form-inline">
		            <form class="listForm" method="post" action="<%=cpath%>/giftCardAction/showGoodsGiftCardDataList.do">
			            ...
			            <div class="col-md-12 ">
		                    <div class="form-group little_distance search" style="line-height: 35px;">
                                ...
                                <div class="search-item">
                                    ...
                                    <label>
                                        <input type="number" name="startRealPay" value="${activityCogVO.startRealPay}"
                                               class="form-control  integer number   input-width-small"
                                               autocomplete="off" min="0" maxlength="9"/>
                                    </label>
                                    <label>-</label>
                                    <label>
                                        <input type="number" name="endRealPay" value="${activityCogVO.endRealPay}" class="form-control
                                         integer number  input-width-small" min="0" autocomplete="off" maxlength="9"/>
                                    </label>
                                </div>
                                <div class="search-item">
                        ...
                        <table class="table table-checkable table-striped table-hover table-bordered plus_end plus_top dt_table mart10"
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="width:4%;" >礼品卡名称</th>
                                    <th style="width:4%;" >礼品卡类型</th>
                                    <th style="width:4%;" >支付方式</th>
