...
<html>
  <head>
    ...
    <script>
                        ...
                        if(datas.result.businessCode==='0'){
                            ...
                            reply.forEach(val => {
                                ...
                                $("#goodsDetailsBody").append('<tr class="checkboxs">' +
                                    '<td class="text_center firstTd" style="vertical-align: middle;"><input type=' +
                                    iType+
                                    ' '+
                                    inputType +
                                    ' name="goodsDetailsBodyCheckbox" value="' + val.goodsId + '"></td>' +
            ...
            $("#addBtn").on("click", function () {
                ...
                for (let i = 0; i < goodsAllList.length; i++) {
                    ...
                    $("#goodsDetailsBodyTable").append('<tr>' +
                        ...
                        'value="'+goodsAllList[i].goodsId+'">删 除' +
                        '                                        </button>' +
                        '</td>' +
                        '</tr>')
        ...
        function removeCheckboxGoodsArray() {
            console.log("惺惺惜惺惺=",$(this).val())
        }
  ...
  <body>
    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li class="current"><a> 新增礼品卡</a></li>
        </ul>
    </div>
    
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" action="<%=cpath%>/giftCardAction/giftCardActivitySave.do" class="form-horizontal row-border validate_form" id="code_form">
                            ...
                            <table class="active_board_table">
                                <tr>
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content">
                                            <select id="giftCardType" name="giftCardType" tag="validate" class="form-control giftCardType  input-width-larger required" >
...
<%--                                                <option value="1">充值卡</option>--%>
                                ...
                                <tr>
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content">
                                            <select id="giftCardStatus" name="giftCardStatus" tag="validate" class="form-control  input-width-larger required" >
                                                <option value="" >请选择</option>
                                                <option value="0">普通礼品卡</option>
                                                <option value="1">商务礼品卡</option>
                                                <option value="2">兑付礼品卡</option>
<%--                                                <option value="3">至尊礼品卡</option>--%>
<%--                                                <option value="4">超级至尊礼品卡</option>--%>
                                            </select>
                                            <label class="validate_tips"></label>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content">
                                            <input name="giftCardName" tag="validate"
                                ...
                                <tr>
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content ">
											<input type="radio" name="cardStatus" value="0" class="tab-radio cardStatus tabsObj" checked style="float:left; cursor: pointer;margin-top: 12px"> <span class="blocker en-larger">待上线</span>
											<input type="radio" name="cardStatus" value="1" class="tab-radio cardStatus tabsObj" style="float:left; cursor: pointer;margin-top: 12px"><span class="blocker en-larger">已上线</span>
											<input type="radio" name="cardStatus" value="2" class="tab-radio cardStatus tabsObj" style="float:left; cursor: pointer;margin-top: 12px"><span class="blocker en-larger">已下线</span>
                                            <label class="validate_tips"></label>
                                        </div>
    ...
    <div class="modal fade" id="qrcodeUploadDialog" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="false"  style="margin-top:-40px;max-height: 100%; overflow: auto; box-sizing: border-box;">
        <div class="modal-dialog" >
