  ...
  <body>
    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
        	...
        	<li class="current"><a title="">修改批次</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form" enctype="multipart/form-data"
            	action="<%=cpath %>/vpointsCoupon/updateBatch.do">
            	<input type="hidden" name="batchKey" value="${bean.batchKey}">
            	<input type="hidden" name="batchCount" value="${bean.batchCount}">
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content batchName">
	                       				<input name="batchName" tag="validate" value="${bean.batchName}"
	                       	 ...
	                       	 <tr>
	                       		<td class="ab_left"><label class="title">追加电子券：<span class="required">*</span></label></td>
	                       		<td class="ab_main">
	                       			<div class="content">
