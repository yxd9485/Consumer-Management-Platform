    ...
    <script>
        ...
        function initPage() {
            ...
            $(".btnSave").on("click", function(){
                ...
                if($("input[name='groupBuyingTotalNum']").val() > goodsRemains){
                	$.fn.alert("拼团总库存不能大于商品总库存");
                	return false;
                }
                ...
                // 提交表单
                var url = "<%=cpath%>/groupBuyingActivity/doGroupBuyingActivityAdd.do";
                $.ajax({
                    type: "POST",
                    url: url,
                    data: paramJson,
                        ...
                        <div class="widget-content panel no-padding">
                            <table class="active_board_table">
                                ...
                                <tr>
		                       		...
		                       		<td class="ab_main" colspan="3">
		                       			<div class="content">
		                       				<input name="groupBuyingPay" tag="validate" value="0.00"  unselectable="on" 
                                ...
                                <tr>
		                       	...
		                       	<tr>
		                       		...
		                       		<td class="ab_main" colspan="3">
		                       			<div class="content">
		                       				<input name="groupBuyingTotalNum" tag="validate" 
		                       	...
		                       	<tr>
		                       		...
		                       		<td class="ab_main" colspan="3">
		                       			<div class="content">
		                       				<input name="limitGroupNum" tag="validate" 
		                       					class="form-control required integer input-width-small rule minValue" autocomplete="off" minval="1" maxlength="9" />
		                       	...
		                       	<tr>
		                       		...
		                       		<td class="ab_main" colspan="3">
		                       			<div class="content">
		                       				<input name="reachNum" tag="validate" 
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content">
                                        	<span class="blocker en-larger">
												<input name="isGroupBuyingLimit" type="checkbox" value="0"/>
											</span>
                                            <span class="blocker en-larger">开启</span>
                                            <span class="blocker en-larger">每人可购买</span>
                                            <input name="groupBuyingLimitNum" class="form-control required integer input-width-small rule" autocomplete="off" maxlength="2" disabled="disabled"/>
                                            <span class="blocker en-larger">件</span>
                                        </div>
                                    </td>
                                </tr>
