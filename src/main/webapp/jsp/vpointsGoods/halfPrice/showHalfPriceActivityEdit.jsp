                ...
                success:  function(datas) {
                    ...
                    if(datas.result.businessCode==='0'){
                        ...
                        for (var index in reply) {
                            ...
                            appendGoodsDetailsTable(reply[index]);
                        }
                    }
                }
            });
  ...
  <body>
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" action="<%=cpath%>/halfPriceActivity/halfPriceActivityUpdate.do" class="form-horizontal row-border validate_form" id="code_form">
                        ...
                        <div class="widget-content panel no-padding">
                            <table class="active_board_table">
									...
									<td class="ab_main" colspan="3">
										<div class="content">
											...
											<input name="consumerBuyLimit" tag="validate"
												   class="form-control required integer number  preValue minValue maxValue input-width-small rule" autocomplete="off"
                                                   value="${activityCog.consumerBuyLimit}"  minVal="1" autocomplete="off" maxlength="5" />
                                ...
                                <tr>
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content">
                                            <input name="discount" tag="validate" value="${activityCog.discount}"
                                                   class="form-control required number preValue minValue maxValue input-width-small rule" minVal="1" maxVal="9.9" autocomplete="off" maxlength="3" />
...
<%--    <div id="tableMater" style="margin-top:-5px;max-height: 278px; overflow: auto; box-sizing: border-box;"><jsp:include page="table1.jsp"></jsp:include></div>--%>
    ...
    <div class="modal fade" id="qrcodeUploadDialog" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="false"
         style="margin-top:-5%;max-height: 100%; overflow: auto; box-sizing: border-box;">
