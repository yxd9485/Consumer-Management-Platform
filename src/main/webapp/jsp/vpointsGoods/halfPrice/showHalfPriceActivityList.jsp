	...
	<script>
		$(function(){
			...
			$("#addItem").click(function(){
				var url = "<%=cpath%>/halfPriceActivity/showHalfPriceActivityAdd.do";
			...
			$("a.edit").on("click", function(){
				...
				var url = "<%=cpath%>/halfPriceActivity/showHalfPriceActivityEdit.do?infoKey="+key;
				$("form").attr("action", url);
				$("form").submit(); 
			});
			// 数据
			...
			$("a.data").on("click", function(){
				var key = $(this).parents("td").data("key");
				var url = "<%=cpath%>/halfPriceActivity/showHalfPriceDataList.do?infoKey="+key;
				$("form").attr("action", url);
				$("form").submit(); 
			});
			...
			$("a.del").on("click", function(){
				var key = $(this).parents("td").data("key");
				var url = "<%=cpath%>/halfPriceActivity/delActivity.do";
            ...
            <div class="widget box">
	            ...
	            <div class="widget-content form-inline">
		            <form class="listForm" method="post"
	                    action="<%=cpath%>/halfPriceActivity/showHalfPriceActivityList.do">
			            ...
			            <div class="col-md-12 ">
		                    <div class="form-group little_distance search" style="line-height: 35px;">
                                <div class="search-item">
			                        ...
			                        <input name="infoName" class="form-control input-width-larger" autocomplete="off" maxlength="30"/>
                                </div>
                                <div class="search-item">
