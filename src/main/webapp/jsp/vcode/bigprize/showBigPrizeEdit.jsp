...
<head>
    ...
    <script>
        ...
        $(function(){
            ...
            if("${vcodePrizeBasicInfo.isExchangeMoney == '1'}" == "true"){
            	$("#exchangeMoneyId").css("display", "");
            }else{
            	$("#exchangeMoneyId").css("display", "none");
            }
        ...
        function initPage() {
            $("#prizeListPic").attr("src",src='${vcodePrizeBasicInfo.prizeListPic}');
            $("#prizeEarnPic").attr("src",src= '${vcodePrizeBasicInfo.prizeEarnPic}');
            $("#prizeWinPic").attr("src",src= '${vcodePrizeBasicInfo.prizeWinPic}');
            $("input[name= prizeListPic]").val('${vcodePrizeBasicInfo.prizeListPic}');
            $("input[name= prizeEarnPic]").val('${vcodePrizeBasicInfo.prizeEarnPic}');
            $("input[name= prizeWinPic]").val('${vcodePrizeBasicInfo.prizeWinPic}');
            ...
            $("input[name='winPrizeTime']:checked").triggerHandler("change");
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath %>/vcodeActivityBigPrize/doBigPrizeEdit.do">
                    ...
                    <div class="widget-content panel no-padding">
                        <table class="active_board_table">
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <input name="infoKey" type="hidden" value="${vcodePrizeBasicInfo.infoKey}"/>
                                    <div class="content">
                                        <input name="prizeName" tag="validate"
                                               class="form-control required" autocomplete="off" maxlength="30" value="${vcodePrizeBasicInfo.prizeName}"/>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
<!--                             <tr> -->
<!--                                 <td class="ab_left"><label class="title">奖品简称：<span class="required">*</span></label></td> -->
<!--                                 <td class="ab_main" colspan="3"> -->
<!--                                     <div class="content"> -->
<!--                                         <input name="prizeShortName" tag="validate" -->
<%--                                                class="form-control required" autocomplete="off" maxlength="30" value="${vcodePrizeBasicInfo.prizeShortName}"/> --%>
<!--                                         <label class="validate_tips"></label> -->
<!--                                     </div> -->
<!--                                 </td> -->
<!--                             </tr> -->
<!--                             <tr> -->
<!--                                 <td class="ab_left"><label class="title">市场价值：<span class="required">*</span></label></td> -->
<!--                                 <td class="ab_main" colspan="3"> -->
<!--                                     <div class="content"> -->
<!--                                         <input name="prizeValue" tag="validate" -->
<%--                                                class="form-control number money input-width-small rule required" autocomplete="off" maxlength="9" value="${vcodePrizeBasicInfo.prizeValue}" /> --%>
<!--                                         <label class="validate_tips"></label> -->
<!--                                     </div> -->
<!--                                 </td> -->
<!--                             </tr> -->
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <select name="prizeType" class="form-control input-width-larger search" autocomplete="off" >
                                            <option value="P"  <c:if test="${vcodePrizeBasicInfo.prizeType eq 'P'}"> selected="selected"</c:if>>实物奖</option>
                                        </select>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="lxPrizeType" class="form-control input-width-larger" autocomplete="off" maxlength="30"  value="${vcodePrizeBasicInfo.lxPrizeType}" />
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <input name="prizeEndTime" id="prizeEndTime"
                                               ...
                                               onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${vcodePrizeBasicInfo.prizeEndTime}"/>
                                                                                <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="cashPrize" value="0"
                                               style="float:left;"   <c:if test= "${vcodePrizeBasicInfo.cashPrize eq '0'}"> checked="checked" </c:if>>
                                        <span class="blocker en-larger" style="margin-left: 2px;">固定截止时间</span>
                                        <input name="cashPrizeEndTime" id="cashPrizeEndTime"
                                               class="form-control input-width-medium Wdate required preTime"
                                               tag="validate"
                                               style="width: 180px !important;" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${vcodePrizeBasicInfo.cashPrizeEndTime}"
                                                <c:if test="${vcodePrizeBasicInfo.cashPrize eq '1'}"> style="width: 180px !important;display:none;"</c:if>/>
                                        <input type="radio" class="tab-radio" name="cashPrize" value="1"
                                               style="float:left; margin-left: 10px !important;" <c:if test= "${vcodePrizeBasicInfo.cashPrize eq '1'}"> checked="checked" </c:if>>
                                        <span class="blocker en-larger" style="margin-left: 2px;">中出后有效兑出天数</span>
                                        <input name="cashPrizeEndDay"
                                               class="form-control required" style="width: 200px;" autocomplete="off" value="${vcodePrizeBasicInfo.cashPrizeEndDay}"
                                                <c:if test="${vcodePrizeBasicInfo.cashPrize eq '0'}"> style="width: 200px;display:none;" </c:if>/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="isExchangeMoney" value="0" style="float:left;" 
                                            <c:if test= "${vcodePrizeBasicInfo.isExchangeMoney eq '0'}"> checked="checked" </c:if> />
                                        <span class="blocker en-larger" style="margin-left: 2px;">不可兑换</span>
                                        <input type="radio" class="tab-radio" name="isExchangeMoney" value="1" style="float:left; margin-left: 10px !important;"
                                            <c:if test= "${vcodePrizeBasicInfo.isExchangeMoney eq '1'}"> checked="checked" </c:if> />
                                        <span class="blocker en-larger" style="margin-left: 2px;">兑换</span>
                                    </div>
                                    <div class="content moneyRange" id="exchangeMoneyId">
                                        <input name="exchangeMinMoney" tag="validate" value="${vcodePrizeBasicInfo.exchangeMinMoney}"
                                            class="form-control money preValue minValue input-width-small" autocomplete="off" maxlength="6" minVal="0.01" maxVal="500"/>
                                        <span class="blocker en-larger">至</span>
                                        <input name="exchangeMaxMoney" tag="validate" value="${vcodePrizeBasicInfo.exchangeMaxMoney}"
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="isRecycle" value="0"
                                               style="float:left;" <c:if test= "${vcodePrizeBasicInfo.isRecycle eq '0'}"> checked="checked" </c:if>>
                                        <span class="blocker en-larger" style="margin-left: 2px;">回收</span>
                                        <input type="radio" class="tab-radio" name="isRecycle" value="1"
                                               style="float:left; margin-left: 10px !important;"<c:if test= "${vcodePrizeBasicInfo.isRecycle eq '1'}"> checked="checked" </c:if>>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="isMsg" value="0"
                                               style="float:left;" <c:if test= "${vcodePrizeBasicInfo.isMsg eq '0'}"> checked="checked" </c:if>>
                                        <span class="blocker en-larger" style="margin-left: 2px;">否</span>
                                        <input type="radio" class="tab-radio" name="isMsg" value="1"
                                               style="float:left; margin-left: 10px !important;"<c:if test= "${vcodePrizeBasicInfo.isMsg eq '1'}"> checked="checked" </c:if>>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="winPrizeTime" value="0"
                                               style="float:left; margin-left: 10px !important;"<c:if test= "${vcodePrizeBasicInfo.winPrizeTime eq '0'}"> checked="checked" </c:if>>
                                        <span class="blocker en-larger" style="margin-left: 2px;">否</span>
                                        <input type="radio" class="tab-radio" name="winPrizeTime" value="1"
                                               style="float:left;" <c:if test= "${vcodePrizeBasicInfo.winPrizeTime eq '1'}"> checked="checked" </c:if>>
                                        <span class="blocker en-larger" style="margin-left: 2px;">是</span>
                                    </div>
                                </td>
                            </tr>
                            <tr class="everyoneLimitType">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="everyoneLimitType" value="0" <c:if test= "${vcodePrizeBasicInfo.everyoneLimitType eq '0'}"> checked="checked" </c:if>
                                               style="float:left; margin-left: 10px !important;"/>
                                        <span class="blocker en-larger" style="margin-left: 2px;">每周</span>
                                        <input type="radio" class="tab-radio" name="everyoneLimitType" value="1" <c:if test= "${vcodePrizeBasicInfo.everyoneLimitType eq '1'}"> checked="checked" </c:if>
                                               style="float:left;"/>
                                        <span class="blocker en-larger" style="margin-left: 2px;">每月</span>
                                        <input name="everyoneLimitNum" tag="validate" value="${vcodePrizeBasicInfo.everyoneLimitNum}"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="dayLimitNum" tag="validate"
                                               class="form-control input-width-small required number integer" value="${vcodePrizeBasicInfo.dayLimitNum}" autocomplete="off" maxlength="9" />
                                        <span class="blocker en-larger">个（0时不限制）</span> 
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="cashPrizeTel" tag="validate"
                                               class="form-control required"  autocomplete="off" maxlength="50" value="${vcodePrizeBasicInfo.cashPrizeTel}"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="cashAdvisoryTime" tag="validate"
                                               class="form-control required"  autocomplete="off" maxlength="250" value="${vcodePrizeBasicInfo.cashAdvisoryTime}"/>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <div class="summernote">${vcodePrizeBasicInfo.prizeContent}</div>
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <select name="verificationType" class="form-control input-width-larger search" autocomplete="off" >
                                        <option value="0"  <c:if test="${vcodePrizeBasicInfo.verificationType eq '0'}"> selected="selected"</c:if>>自提方式</option>
                                        <option value="1"  <c:if test="${vcodePrizeBasicInfo.verificationType eq '1'}"> selected="selected"</c:if>>物流发货（有核销码）</option>
                                        <option value="3"  <c:if test="${vcodePrizeBasicInfo.verificationType eq '3'}"> selected="selected"</c:if>>物流发货（无核销码）</option>
                                        <option value="2"  <c:if test="${vcodePrizeBasicInfo.verificationType eq '2'}"> selected="selected"</c:if>>在线直接领取</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="isName" type="hidden"   value = "${vcodePrizeBasicInfo.isName}"/>
                                        <input id="isName" type="checkbox" data-on-text="需要" data-off-text="不需要" <c:if test="${vcodePrizeBasicInfo.isName eq '1'}"> checked </c:if>/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="isPhone" type="hidden"   value = "${vcodePrizeBasicInfo.isPhone}"/>
                                        <input id="isPhone" type="checkbox" data-on-text="需要" data-off-text="不需要" <c:if test="${vcodePrizeBasicInfo.isPhone eq '1'}"> checked </c:if>/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="isIdcard" type="hidden"   value = "${vcodePrizeBasicInfo.isIdcard}"/>
                                        <input id="isIdcard" type="checkbox" data-on-text="需要" data-off-text="不需要" <c:if test="${vcodePrizeBasicInfo.isIdcard eq '1'}"> checked </c:if>/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="isAddress" type="hidden" value = "${vcodePrizeBasicInfo.isAddress}"/>
                                        <input id="isAddress" type="checkbox" data-on-text="需要" data-off-text="不需要" <c:if test="${vcodePrizeBasicInfo.isAddress eq '1'}"> checked </c:if>/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="isCheckCaptcha" type="hidden" value = "${vcodePrizeBasicInfo.isCheckCaptcha}"/>
                                        <input id="isCheckCaptcha" type="checkbox" data-on-text="需要" data-off-text="不需要" <c:if test="${vcodePrizeBasicInfo.isCheckCaptcha eq '1'}"> checked </c:if>/>
                                    </div>
                                </td>
                            </tr>
