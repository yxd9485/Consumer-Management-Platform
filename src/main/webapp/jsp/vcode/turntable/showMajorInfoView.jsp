...
<div class="container">
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li class="current"><a title="">中奖用户</a></li>
            <li class="current"><a title="">查看</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath%>/turntable/showTurnTableRecordList.do?activityKey=${activityKey}">
                ...
                <div class="widget box">
                    ...
                    <div class="widget-content panel no-padding">
                        <table class="active_board_table">
                            ...
                            <tr>
                                <td class="ab_left"><label class="title">物流信息：</label></td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <span class="blocker">${majorInfo.expressCompany}:${majorInfo.expressNumber}</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="ab_left"><label class="title">发货备注：</label></td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <span class="blocker">${majorInfo.expressSendMessage}</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
