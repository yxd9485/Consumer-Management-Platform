...
<head>
    ...
    <script>
        ...
        function initPage() {
            ...
            $(".btnSave").click(function () {
                ...
                if (flag) {
                    ...
                    if ($("input[name='rebateScopeType']:checked").val() == "1") {
            ...
            // 查询组织机构
            $("select[name='dmRegionAry']").on("change", function(){
                var departmentId = $(this).val();
                if(departmentId == '' || departmentId == null){
                    $("select[name='dmProvinceAry']").html("<option value=''>请选择</option>");
                    $("select[name='agencyAry']").html("<option value=''>请选择</option>");
                    return;
                }
                ...
                $.ajax({
                    ...
                    success:  function(result){
                        ...
                        if(result){
                            ...
                            $("select[name='dmProvinceAry']").html(content);
                        } else {
                            $("select[name='dmProvinceAry']").html(content);
                        }
                    },
            ...
            // 查询经销商
            $("select[name='dmProvinceAry']").on("change", function(){
                var id = $(this).val();
                if(id == '' || id == null){
                    $("select[name='agencyAry']").html("<option value=''>请选择</option>");
                    return;
                ...
                $.ajax({
                    ...
                    success:  function(result){
                        ...
                        if(result){
                            ...
                            $("select[name='agencyAry']").html(content);
                        } else {
                            $("select[name='agencyAry']").html(content);
                        }
                    },
        ...
        // 计算奖项个数
        function calculationPrizeCount() {
            if (!calculateUnitFlag) return;
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="import_form"
                ...
                <input type="hidden" name="vcodeActivityKey" value="${activityKey}"/>
                ...
                <div class="widget box">
                    ...
                    <div class="widget-content panel no-padding">
                        <table class="active_board_table">
                            ...
                            <tr>
                                <td class="ab_left"><label class="title mart5">规则类型：<span class="white">*</span></label>
                                </td>
                                <td class="ab_main">
                                    <div class="content">
                            ...
                            <tr>
                                ...
                                <td class="ab_left"><label class="title mart5">活动时间：<span
                                        class="required">*</span></label></td>
                                <td class="ab_main date">
                                    <div class="content date" style="margin: 5px 0px;">
                                        <span class="blocker">从</span>
                                        <input name="beginDate" id="beginDate0"
                                               class="Wdate form-control input-width-medium"
                                               onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', maxDate:'#F{$dp.$D(\'endDate0\')}'})"
                                               autocomplete="off"/>
                                        <span class="blocker en-larger">至</span>
                                        <input name="endDate" id="endDate0"
                                               class="Wdate form-control input-width-medium"
                                               onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'#F{$dp.$D(\'beginDate0\')}'})"
                                               autocomplete="off"/>
                                    ...
                                    <div class="content week" style="margin: 5px 0px;">
                                        ...
                                        <input name="endDate" id="endDate" class="form-control input-width-medium"
                                               onblur="changeWeek(this)" autocomplete="off"/>
                                        <label class="title mart5 btn-txt-add-red"
                                               style="font-weight: normal; margin-left: 5px;" id="addWeek">新增</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="active_table_submit mart20">
                        <div class="button_place">
                            ...
                            <button class="btn btnReturn btn-radius3"
                                    url="<%=cpath%>/turntable/showTurntableActivityRuleCogList.do?activityKey=${activityKey}">
                                返 回
                            </button>
                        </div>
                    </div>
