    ...
    <script>
        ...
        function validForm() {
            ...
            $("td.perItem div.perItem").each(function(i){
                ...
                perItemAry += uuid() + ":" + $perItem.val() + ":" + $moneys.val() + ":" + $vpoints.val() + ":"  + $launchPerDay.val() + ";";
            });
            if(returnFlag){
                return false;
            }
            ...
            // 校验活动是否有冲突
            validCogByActivityKey("", vcodeActivityKeys, minBeginDate, maxEndDate);
            if(!flagStatus){
                return false;
            }
...
<div class="container">
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li class="current"><a>新增频次配置</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath%>/frequency/addFrequencyCog.do">
                ...
                <div class="widget box">
                    <div class="widget-header">
                        <h4><i class="iconfont icon-xinxi"></i>新增频次配置</h4>
                    </div>
                    <div class="widget-header">
                    ...
                    <div class="widget-content panel no-padding">
                        <table class="active_board_table">
                            ...
                            <tr>
                                ...
                                <td class="ab_main date">
                                    <div class="content date" style="margin: 5px 0px; display: flex;">
                                        <span class="blocker en-larger">日期</span>
                                        ...
                                        <input name="beginTime" id="beginTime" class="form-control input-width-medium Wdate required"
                                               tag="validate" value="00:00:00" autocomplete="off" onfocus="WdatePicker({dateFmt:'HH:mm:ss'})" />
                                        <span class="blocker en-larger">至</span>
                                        <input name="endTime" id="endTime" class="form-control input-width-medium Wdate required"
                            ...
                            <tr>
                                <td class="ab_left"><label class="title">中出限制类型：<span class="required">*</span></label></td>
                                <td class="ab_main" colspan="3">
                                    ...
                                    <b id="remark1"  style="color: red">规则时间内每个频次规则中能中出一次。</b>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <input name="restrictUserCount" tag="validate"
                                ...
                                <td class="ab_main perItem">
                                    <div class="content perItem" style="margin: 5px 0px;">
                                        ...
                                        <input type="text" name="perItem" class="form-control input-width-small number integer maxValue"  autocomplete="off"
                                               tag="validate" data-oldval="0" value="0" maxVal="999999" maxlength="6">
                                        ...
                                        <input type="text" name="moneys" class="form-control input-width-small money maxValue"  autocomplete="off"
                                               tag="validate" data-oldval="0.00" value="0.00" maxVal="9999.00" maxlength="7">
                                        ...
                                        <input type="text" name="vpoints" class="form-control input-width-small number integer maxValue"  autocomplete="off"
                                               tag="validate" data-oldval="0" value="0" maxVal="9999" maxlength="4">
                                        ...
                                        <input type="text" name="launchPerDay" class="form-control input-width-small number integer maxValue"  autocomplete="off"
                                               tag="validate" data-oldval="0" value="0" maxVal="99999999" maxlength="8">
