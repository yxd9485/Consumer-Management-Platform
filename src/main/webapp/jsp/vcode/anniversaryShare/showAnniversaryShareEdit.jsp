...
<head>
    ...
    <script>
        ...
        function initPage() {
            ...
            var imgData = '${vpsAnniversaryShare.picUrl}';
            if (imgData) {
                showImg(imgData);
            }
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath%>/anniversaryShare/doAnniversaryShareEdit.do">
                <input type="hidden" name="picUrl" value="${vpsAnniversaryShare.picUrl}"/>
                <input type="hidden" name="shareKey" value="${vpsAnniversaryShare.shareKey}"/>
                    ...
                    <div class="widget-content panel no-padding">
                        <table class="active_board_table">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <select name="shareType" class="form-control input-width-large search">
                                            <option value="0"
                                                    <c:if test="${vpsAnniversaryShare.shareType eq '0'}">selected</c:if>>
                                                微信公众号
                                            </option>
                                            <option value="1"
                                                    <c:if test="${vpsAnniversaryShare.shareType eq '1'}">selected</c:if>>
                                                微信视频号
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="shareTitle" tag="validate"
                                               value="${vpsAnniversaryShare.shareTitle}"
                            ...
                            <tr class="articleJump"
                                <c:if test="${vpsAnniversaryShare.shareType eq '1'}">style="display: none;"</c:if>>
                                <td class="ab_left"><label class="title">公众号链接：<span class="required">*</span></label>
                                </td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="jumpUrl" tag="validate" value="${vpsAnniversaryShare.jumpUrl}"
                            ...
                            <tr class="videoJump"
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="videoId" tag="validate" value="${vpsAnniversaryShare.videoId}"
                                               class="form-control required" autocomplete="off" maxlength="150"/>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <input name="stgmt" id="stgmt" value="${vpsAnniversaryShare.stgmt}"
                                        ...
                                        <input name="endgmt" id="endgmt" value="${vpsAnniversaryShare.endgmt}"
                                ...
                                <td class="ab_main" colspan="3">
                                    <div tag="validate" class="content">
                                        <input name="shareOrder" tag="validate"
                                               value="${vpsAnniversaryShare.shareOrder}"
