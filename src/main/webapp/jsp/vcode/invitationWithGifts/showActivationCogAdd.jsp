    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath %>/invitationWithGifts/addActivity.do">
                ...
                <div class="widget box">
                    ...
                    <div class="widget-content panel no-padding">
                        <table class="active_board_table">
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="remarks" class="form-control" autocomplete="off" maxlength="50" />
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="widget-content panel no-padding filteruser">
                        <table class="active_board_table">
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="vpoints" value="0"  type="number" class="form-control input-width-larger integer minValue maxValue required"
                    ...
                    <div class="active_table_submit mart20">
                        <div class="button_place">
                            ...
                            <button class="btn btnReturn btn-radius3" data-url="<%=cpath%>/invitationWithGifts/showActivityList.do?vjfSessionId=${vjfSessionId}&isBegin=0">返 回</button>
                        </div>
                    </div>
                </div>
