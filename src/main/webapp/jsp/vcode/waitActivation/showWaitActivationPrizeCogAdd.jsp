...
<head>
    ...
    <script>
        ...
        function validForm() {
            ...
            if ($("input[name='everyoneLimitNum']").val() != '' && Number($("input[name='everyoneLimitNum']").val()) > 999) {
                alert("单人单日可中出最大值为999");
                return false;
            }
            if ($("input[name='cashPrizeEndDay']").val() != '' && Number($("input[name='cashPrizeEndDay']").val()) > 365) {
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath%>/waitActivationPrize/doWaitActivationPrizeCogAdd.do">
                <input type="hidden" name="activeImgUrl" id="activeImgUrl"/>
...
<%--                            </tr>--%>
                            ...
                            <tr>
                                ...
                                <td class="ab_main sku" colspan="3">
                                    <div class="content sku promotionSku" style="display: flex; margin: 5px 0px;">
                                        <select class="form-control input-width-larger required" id="skus"
                                                name="skus" tag="validate">
                                            <option value="">请选择SKU</option>
                                            <c:if test="${!empty skuList}">
                                                <c:forEach items="${skuList}" var="sku">
                                                    <option value="${sku.skuKey}@@@${sku.skuName}@@@${sku.shortName}">${sku.skuName}</option>
                                                </c:forEach>
                                            </c:if>
                                        </select>
                            ...
                            <tr >
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="cashPrizeEndDay" tag="validate"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="everyoneLimitNum" tag="validate"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="dayMoneyLimit" tag="validate"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="totalMoneyLimit" tag="validate"
                                               class="form-control input-width-larger money minValue maxValue" autocomplete="off" minVal="0.01" maxVal="999999999.99"  maxlength="12" />
                                        <span class="blocker en-larger">元</span>
                                        <label class="validate_tips"></label>
                                    </div>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div style="height: 163px;width: 800px; float: left;" class="img-box full">
                                        <section class="img-section" data-imgnum="4">
                                            <input id="imgUrl" name="imgUrl" type="hidden" class='filevalue'/>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3"><div class="summernote"></div></td>
                            </tr>
                        </table>
                    </div>
