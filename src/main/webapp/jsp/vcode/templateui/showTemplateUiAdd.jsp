...
<head>
    ...
    <script>
        ...
        function initPage() {
            $("#logoPic").attr("src",src='${vpsTemplateUi.homeLogoPic.picUrl}');
            $("#homeBackgroundPic.picInfo.picWidth").val('${vpsTemplateUi.homeLogoPic.picWidth}');
            $("#homeBackgroundPic.picInfo.picHeight").val('${vpsTemplateUi.homeLogoPic.picHeight}');
            $("#homeBackgroundPic.picInfo.picX").val('${vpsTemplateUi.homeLogoPic.picX}');
            $("#homeBackgroundPic.picInfo.picY").val('${vpsTemplateUi.homeLogoPic.picY}');
            $("#backgroundPic").attr("src",src='${vpsTemplateUi.homeBackgroundPic.picUrl}');
            $("#sloganPic").attr("src",src='${vpsTemplateUi.homeSloganPic.picUrl}');
            $("#openRedpacketPic").attr("src",src='${vpsTemplateUi.homeOpenRedpacketPic.picUrl}');
                    ...
                    success: function(data) {
                        if (data['errMsg'] != "添加成功") {
                            ...
                            if (data["templateKey"]) {
                                ...
                                $("#ruleFrame").attr("src", "<%=cpath%>/templateUi/showAuthAdd.do?vjfSessionId=${vjfSessionId}&templateKey=" + data["templateKey"]);
                            } else {
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 tabbable tab-group">
            <a class="btn tab btn-red">模板选择</a>
                        ...
                        <div class="widget-content panel no-padding">
                            <table class="active_board_table">
                                ...
                                <tr>
                                    ...
                                    <input name="homeBackgroundPic.picInfo.picWidth" id="homeBackgroundPic.picInfo.picWidth" tag="validate" value="FFFFF"
                                           class="form-control required" autocomplete="off" maxlength="10" placeholder = "宽"  type="hidden"/>
                                    <input name="homeBackgroundPic.picInfo.picHeight" id="homeBackgroundPic.picInfo.picHeight" tag="validate"
                                           class="form-control required" autocomplete="off" maxlength="10"  placeholder = "高" type="hidden"/>
                                    <input name="homeBackgroundPic.picInfo.picX" id="homeBackgroundPic.picInfo.picX" tag="validate"
                                           class="form-control required" autocomplete="off" maxlength="10"  placeholder = "坐标x"type="hidden"/>
                                    <input name="homeBackgroundPic.picInfo.picY" id="homeBackgroundPic.picInfo.picY" tag="validate"
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content">
                                            <div class="item">
                                                ...
                                                <input name="homeSloganPic.picInfo.picWidth" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10" placeholder = "宽"  type="hidden"/>
                                                <input name="homeSloganPic.picInfo.picHeight" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10"  placeholder = "高" type="hidden"/>
                                                <input name="homeSloganPic.picInfo.picX" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10"  placeholder = "坐标x"type="hidden"/>
                                                <input name="homeSloganPic.picInfo.picY" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10" placeholder = "坐标y" type="hidden"/>
                                            </div>
                                            <div style="clear: left;"></div>
                                        </div>
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content">
                                            <div class="item">
                                                ...
                                                <input  type="hidden" name="sloganPic">
                                                <input name="homeOpenRedpacketPic.picInfo.picWidth" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10" placeholder = "宽"  type="hidden"/>
                                                <input name="homeOpenRedpacketPic.picInfo.picHeight" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10"  placeholder = "高" type="hidden"/>
                                                <input name="homeOpenRedpacketPic.picInfo.picX" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10"  placeholder = "坐标x"type="hidden"/>
                                                <input name="homeOpenRedpacketPic.picInfo.picY" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10" placeholder = "坐标y" type="hidden"/>
                                            </div>
                                            <div style="clear: left;"></div>
                                        </div>
                                    ...
                                    <td class="ab_main" colspan="3">
                                        <div class="content">
                                            <div class="item">
                                                ...
                                                <input  type="hidden" name="sloganPic">
                                                <input name="homeLogoPic.picInfo.picWidth" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10" placeholder = "宽"  type="hidden"/>
                                                <input name="homeLogoPic.picInfo.picHeight" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10"  placeholder = "高" type="hidden"/>
                                                <input name="homeLogoPic.picInfo.picX" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10"  placeholder = "坐标x"type="hidden"/>
                                                <input name="homeLogoPic.picInfo.picY" tag="validate"
                                                       class="form-control required" autocomplete="off" maxlength="10" placeholder = "坐标y" type="hidden"/>
                                            </div>
                                            <div style="clear: left;"></div>
                                        </div>
...
<%--                                        <div class="content">--%>
<%--                                            <div class="item">--%>
<%--                                                <img class="addImg"  id = "backgroundPic1"  onclick="clickImg(this);" src="<%=cpath %>/inc/vpoints/img/a11.png" width="20" height="20" />--%>
<%--                                                <input type="hidden" name="backgroundPic">--%>
<%--                                            </div>--%>
<%--                                            <div style="clear: left;"></div>--%>
<%--                                        </div>--%>
...
<%--                                        <div class="content">--%>
<%--                                            <div class="item">--%>
<%--                                                <img class="addImg"  id = "sloganPic1" onclick="clickImg(this);" src="<%=cpath %>/inc/vpoints/img/a11.png" width="20" height="20" />--%>
<%--                                                <input  type="hidden" name="sloganPic">--%>
<%--                                            </div>--%>
<%--                                            <div style="clear: left;"></div>--%>
<%--                                        </div>--%>
...
<%--                                        <div class="content">--%>
<%--                                            <div class="item">--%>
<%--                                                <img class="addImg"  id = "openRedpacketPic1" onclick="clickImg(this);" src="<%=cpath %>/inc/vpoints/img/a11.png" width="50" height="50" />--%>
<%--                                                <input  type="hidden" name="openRedpacketPic">--%>
<%--                                            </div>--%>
<%--                                            <div style="clear: left;"></div>--%>
<%--                                        </div>--%>
...
<%--                                        <div class="content">--%>
<%--                                            <div class="item">--%>
<%--                                                <img class="addImg"  id = "logoPic1" onclick="clickImg(this);" src="<%=cpath %>/inc/vpoints/img/a11.png" width="50" height="50"  />--%>
<%--                                                <input  type="hidden" name="logoPic" >--%>
<%--                                            </div>--%>
<%--                                            <div style="clear: left;"></div>--%>
<%--                                        </div>--%>
...
<%--                                        <div class="content">--%>
<%--                                            <div class="item">--%>
<%--                                                <img class="addImg"  id = "showPic" onclick="clickImg(this);" src="<%=cpath %>/inc/vpoints/img/a11.png" width="50" height="50"  />--%>
<%--                                                &lt;%&ndash;                                                <input  type="hidden" name="showPic" >&ndash;%&gt;--%>
<%--                                            </div>--%>
<%--                                            <div style="clear: left;"></div>--%>
<%--                                        </div>--%>
<%--                                    </td>--%>
