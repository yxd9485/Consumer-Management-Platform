  ...
  <head>
	...
	<script>
		...
		function validForm() {
        	...
        	var expandMaxMoney = Number($("input[name='expandMaxMoney']").val());
                        		...
                        		<td class="ab_main date">
                        			<div class="content date" style="margin: 5px 0px; display: flex;">
                                        ...
                                        <input name="endDate" id="endDate" class="Wdate form-control input-width-medium required sufTime"  value="${expandRule.endDate}"
                                            autocomplete="off" tag="validate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'#F{$dp.$D(\'beginDate\')}'})" />
		                                <label class="validate_tips"></label>
                        			</div>
                        		</td>
                        	</tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="expandNum" tag="validate"  value="${expandRule.expandNum}"
                                            class="form-control input-width-larger number positive minValue maxValue" autocomplete="off" minVal="1" maxVal="100" maxlength="6" />
