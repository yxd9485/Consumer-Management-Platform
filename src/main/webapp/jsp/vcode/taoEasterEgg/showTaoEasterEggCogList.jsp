	...
	<script>
		$(function(){
			...
			$("#addItem").click(function(){
				var url = "<%=cpath%>/taoEasterEgg/showTaoEasterEggCogAdd.do";
			...
			$("a.edit").on("click", function(){
				...
				var url = "<%=cpath%>/taoEasterEgg/showTaoEasterEggCogEdit.do?infoKey="+key;
				$("form").attr("action", url);
				$("form").submit(); 
			});
			...
			$("a.view").on("click", function(){
				var key = $(this).parents("td").data("key");
				var url = "<%=cpath%>/taoEasterEgg/showTaoEasterEggCogView.do?infoKey="+key;
				$("form").attr("action", url);
				$("form").submit(); 
			});
			...
			$("a.del").on("click", function(){
				var key = $(this).parents("td").data("key");
				var url = "<%=cpath%>/taoEasterEgg/doTaoEasterEggCogDel.do?infoKey="+key;
            ...
            <div class="widget box">
	            ...
	            <div class="widget-content form-inline">
		            <form class="listForm" method="post"
	                    action="<%=cpath%>/taoEasterEgg/showTaoEasterEggCogList.do">
                        ...
                        <table class="table table-checkable table-striped table-hover table-bordered plus_end plus_top dt_table mart10"
                            ...
                            <thead>
                                 <tr>
                                    ...
                                    <th style="width:10%;" data-ordercol="tao_no">规则编号</th>
                                    <th style="width:28%;" data-ordercol="tao_name">规则名称</th>
                                    <th style="width:15%;" data-ordercol="start_date">规则时间</th>
                                    <th style="width:10%;" data-ordercol="ladder_type">阶梯类型</th>
					        ...
					        <tbody>
					        	...
					        	<tr>
					        		...
					        		<td style="text-align:center;">
					        			<span>${item.taoNo}</span>
					        		</td>
					        		<td>
					        			<span>${item.taoName}</span>
					        		</td>
					        		<td style="text-align:center;">
					        		...
					        		<td style="text-align:center;">
					        			<c:choose>
					        				<c:when test="${item.ladderType  eq '0'}"><span>单个活动</span></c:when>
					        				<c:when test="${item.ladderType  eq '1'}"><span>组合活动</span></c:when>
