  ...
  <body>
    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li class="current"><a title="">风控规则模板新增</a></li>
            <li class="current"><a title="">新增风控规则模板</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
            	action="<%=cpath%>/doubtTemplet/doDoubtTempletAdd.do">
                	...
                	<div class="widget-content panel no-padding">
                		<table class="active_board_table">
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="sameMinuteRestrict" tag="validate" placeholder="同一分钟扫码次数大于或等于"
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="sameDayRestrict" tag="validate" placeholder="同一天扫码次数大于或等于"
	                       					class="form-control input-width-larger number positive minValue" autocomplete="off" minVal="1" maxlength="5" />
	                       					<span class="blocker en-larger">次</span>
	                       				<label class="validate_tips"></label>
	                       			</div>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="sameMonthRestrict" tag="validate" placeholder="同一月扫码次数大于或等于" 
                                               class="form-control input-width-larger number positive minValue" autocomplete="off" minVal="1" maxlength="5" />
                                        <span class="blocker en-larger">次</span>
                                        <label class="validate_tips"></label>
                                    </div>
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="historyTimesRestrict" tag="validate" placeholder="历史累计扫码次数大于或等于"
	                       					class="form-control input-width-larger number positive minValue" autocomplete="off" minVal="1" maxlength="5" />
	                       					<span class="blocker en-larger">次</span>
	                       				<label class="validate_tips"></label>
	                       			</div>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio doubtRadioMoney" name="doubtfulTimeLimitType" value="0" checked="checked"  style="float:left; cursor: pointer;" />
                                        <span class="blocker en-larger">3天</span>
                                        <input type="radio" class="tab-radio doubtRadioScore" name="doubtfulTimeLimitType" value="1" style="float:left; cursor: pointer;" />
                                        <span class="blocker en-larger">7天</span>
                                        <input type="radio" class="tab-radio doubtRadioScore" name="doubtfulTimeLimitType" value="2" style="float:left; cursor: pointer;" />
                                        <span class="blocker en-larger">15天</span>
                                        <input type="radio" class="tab-radio doubtRadioScore" name="doubtfulTimeLimitType" value="3" style="float:left; cursor: pointer;" />
                                    ...
                                    <div class="content" colspan="3"style="float:left;width:95%">
                                        <input type="radio" class="tab-radio doubtRadioMoney" 
                                    ...
                                    <div class="content" colspan="3"style="float:left;width:95%">
                                        <input type="radio" class="tab-radio doubtRadioMoney" 
                                               name="doubtfulTimeLimitType" value="5"  style="float:left; cursor: pointer;" />
                                    ...
                                    <br>
                                    <div class="content" colspan="3"style="float:left;width:95%">
                                        <input type="radio" class="tab-radio doubtRadioMoney" name="doubtfulTimeLimitType" value="6"  style="float:left; cursor: pointer;" />
