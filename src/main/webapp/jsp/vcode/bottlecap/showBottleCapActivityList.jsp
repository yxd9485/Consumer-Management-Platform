    ...
    <script>
        $(function(){
            ...
            $("#addItem").click(function(){
                var url = "<%=cpath%>/bottleCap/showBottleCapActivityAdd.do";
            ...
            $("a.edit").on("click", function(){
                ...
                var url = "<%=cpath%>/bottleCap/showBottleCapActivityEdit.do?activityKey="+key;
                $("form").attr("action", url);
                $("form").submit();
            });
            ...
            $("a.del").on("click", function(){
                var key = $(this).parents("td").data("key");
                var url = "<%=cpath%>/bottleCap/doBottleCapActivityDel.do?activityKey="+key;
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <div class="widget box">
                <div class="row">
                    <div class="col-md-2"><span style="font-size: 15px; color: white; font-weight: bold;">积盖活动查询</span></div>
                ...
                <div class="widget-content form-inline">
                    <form class="listForm" method="post"
                          action="<%=cpath%>/bottleCap/showBottleCapActivityList.do">
                                    ...
                                    <c:forEach items="${resultList}" var="item" varStatus="idx">
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
					        			     <span>
										     	<c:choose>
                                                    <c:when test="${item.activityType eq '0'}">累计</c:when>
                                                    <c:when test="${item.activityType eq '1'}">消耗</c:when>
                                                </c:choose>
										     </span>
                                            </td>
                                            <td>
                                            ...
                                            <td data-key="${item.activityKey}" style="text-align: center;">
