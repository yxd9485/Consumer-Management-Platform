  ...
  <head>
	...
	<script>
		...
		function initPage() {
			...
			var startDate = new Date("${promotionCog.startDate}");
			var endDate = new Date("${promotionCog.endDate}" + " 23:59:59");
			...
			// 可疑用户 可疑规则类型：1：系数；2：区间
			if ("${promotionCog.doubtRuleType}" == "2") {
				$("tr.doubtRate").find("input.positive").prop("disabled", true);
				$("tr.doubtRange").find("input[type=radio]").attr("checked", "checked");
			} else {
				$("tr.doubtRange").find("input.money").prop("disabled", true);
				$("tr.doubtRate").find("input[type=radio]").attr("checked", "checked");
			}
		...
		function checkName(bussionName){
			$.ajax({
			    ...
			    data:{
			    		"infoKey":"${promotionCog.activityKey}",
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
            	action="<%=cpath %>/promotion/doBindPromotionEdit.do">
                	...
                	<div class="widget-content panel no-padding">
                		<table class="active_board_table">
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="activityName" tag="validate"
	                       					class="form-control required" autocomplete="off" maxlength="200" value="${promotionCog.activityName}"/>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
                                        ...
                                        <input name="startDate" class="form-control input-width-medium Wdate required preTime"
                                       		tag="validate" autocomplete="off" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'%y-%M-%d'})" value="${promotionCog.startDate}"/>
                                       	<span class="blocker en-larger">至</span>
                                       	<input name="endDate" class="form-control input-width-medium Wdate required sufTime"
                                       		tag="validate" autocomplete="off" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'%y-%M-%d'})" value="${promotionCog.endDate}"/>
                                       	<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
	                       	</tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<select name="periodType" class="form-control input-width-larger">
	                       					...
	                       					<option <c:if test="${promotionCog.periodType == '1'}"> selected</c:if> value="1">月</option>
	                       					<option <c:if test="${promotionCog.periodType == '2'}"> selected</c:if> value="2">天</option>
	                       				</select>
	                       				<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="prizeUpperLimit" tag="validate" value="${promotionCog.prizeUpperLimit}"
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
		                       		<div class="content">
		                       			...
		                       			<input type="radio" class="tab-radio" name="prizeGainType" <c:if test="${promotionCog.prizeGainType == '0'}"> checked</c:if> value="0" style="float:left;" disabled="disabled" />
	                       				<span class="blocker en-larger" style="padding-right: 8px;">替换扫码红包</span>
		                       			<input type="radio" class="tab-radio" name="prizeGainType" <c:if test="${promotionCog.prizeGainType == '1'}"> checked</c:if> value="1" style="float:left; " disabled="disabled" />
	                       				<span class="blocker en-larger">额外红包</span>
									</div>
	                       		</td>
	                       	</tr>
					       	<tr>
					       			...
					       			<div class="content skuInfo">
					       				<select class="form-control input-width-larger required" name="promotionSkuKey" id="skuKeySelect" tag="validate">
					       					...
					       					<c:forEach items="${skuList}" var="sku">
					       						<option value="${sku.skuKey}" <c:if test="${promotionCog.promotionSkuKey == sku.skuKey}"> selected</c:if> data-img="${sku.skuLogo}">${sku.skuName}</option>
					       					</c:forEach>
					       					</c:if>
					       				</select>
					                      	<label class="validate_tips"></label>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="promotionSkuNum" tag="validate"
	                       					class="form-control input-width-larger positive required" autocomplete="off" maxlength="5" value="${promotionCog.promotionSkuNum}"/>
	                       				<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
	                       	</tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				...
	                       				<input name="doubtRuleCoe" tag="validate" mark="blacklist"
	                       					...
	                       					autocomplete="off" maxlength="9" minVal="1" maxVal="100" value="${promotionCog.doubtRuleCoe}" />
                			...
                			<tr class="doubt-rule doubtRange">
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content doubt">
	                       				...
	                       				<input name="doubtRuleRangeMin" tag="validate" mark="blacklist" value="${promotionCog.doubtRuleRangeMin}" 
	                       					class="form-control money preValue maxValue input-width-small" autocomplete="off" maxlength="5" maxVal="99"/>
	                       				<span class="blocker en-larger">至</span>
	                       				<input name="doubtRuleRangeMax" tag="validate" mark="blacklist" value="${promotionCog.doubtRuleRangeMax}" 
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<textarea name="activityDesc" tag="validate" rows="5"
	                       					class="form-control required" autocomplete="off" maxlength="1000" >${promotionCog.activityDesc}</textarea>
	                       				<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
	                       	</tr>
                	...
                	<div id="skuList" class="widget-content panel no-padding">
                		<table class="active_board_table">
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<select name="skuRelationType" class="form-control input-width-larger">
	                       					...
	                       					<option <c:if test="${promotionCog.skuRelationType == '1'}"> selected</c:if> value="1">或者</option>
	                       					<option <c:if test="${promotionCog.skuRelationType == '2'}"> selected</c:if> value="2">混合</option>
	                       				</select>
	                       				<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
		                       		<div class="content">
		                       			<input type="radio" class="tab-radio" name="skuRelationPeriod" <c:if test="${promotionCog.skuRelationPeriod == '0'}"> checked</c:if> value="0" style="float:left;" />
	                       				<span class="blocker en-larger" style="padding-right: 8px;">本期</span>
		                       			<input type="radio" class="tab-radio" name="skuRelationPeriod" <c:if test="${promotionCog.skuRelationPeriod == '1'}"> checked</c:if> value="1" style="float:left; margin-left: 5px;" />
                		...
                		<table id="skuTable" class="active_board_table sku_table" style="border:1px solid green; display: none;">
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content skuInfo">
	                       				<div style="position:relative; display: inline-block; float: left;" >
	                       					<c:if test="${!empty skuList}">
		                       					<c:forEach items="${skuList}" var="sku">
		                       						<input name="skuKey" id="skuKeyCheckBox" type="checkbox"  value="${sku.skuKey}" data-img="${sku.skuLogo}" tag="validate"
		                       						<c:if test="${promotionCog.skuRelationType == '2' and fn:contains(signinSkuCogLst[0].skuKey, sku.skuKey) }">checked</c:if> /><label id="skuKeyCheckBoxLabel" data-img="${sku.skuLogo}">${sku.skuName}</label></br>
		                       					</c:forEach>
	                       					</c:if>
                       					</div>
                                       	<label class="validate_tips"></label>
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<select name="signType" class="form-control input-width-larger">
	                       					...
	                       					<option <c:if test="${promotionCog.skuRelationType == '2' and signinSkuCogLst[0].signType == '1' }">selected</c:if> value="1">次</option>
	                       				</select>
	                       				<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
				   			...
				   			<tr>
				           		...
				           		<td class="ab_main" colspan="3">
				           			<div class="content">
				           				<select name="signOperator" class="form-control input-width-larger" tag="validate">
				           					<option <c:if test="${promotionCog.skuRelationType == '2' and signinSkuCogLst[0].signOperator == '1' }">selected</c:if> value="1">小于等于</option>
				           					<option <c:if test="${promotionCog.skuRelationType == '2' and signinSkuCogLst[0].signOperator == '2' }">selected</c:if> value="2">等于</option>
				           					<option <c:if test="${promotionCog.skuRelationType == '2' and signinSkuCogLst[0].signOperator == '3' }">selected</c:if> value="3">大于等于</option>
				           				</select>
				           				<label class="validate_tips"></label>
				           			</div>
				           		</td>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="signNum" tag="validate"
	                       					class="form-control input-width-larger number" autocomplete="off" maxlength="5" value="${signinSkuCogLst[0].signNum}"/>
	                       				<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
	                       	</tr>
						           		...
						           		<td class="ab_main" colspan="3">
						           			<div class="content">
						           				<select name="signOperator" class="form-control input-width-larger">
						           					<option <c:if test="${skuCogItem.signOperator == '1' }">selected</c:if> value="1">小于等于</option>
						           					<option <c:if test="${skuCogItem.signOperator == '2' }">selected</c:if> value="2">等于</option>
						           					<option <c:if test="${skuCogItem.signOperator == '3' }">selected</c:if> value="3">大于等于</option>
						           				</select>
						           				<label class="validate_tips"></label>
						           			</div>
						           		</td>
