  ...
  <head>
	...
	<script>
		...
		function validForm() {
			...
			// SKU
			var skuKey = $("select[name='skuKey']").val();
			if(skuKey == ""){
				$("select[name='skuKey']").parents(".skuInfo").find(".validate_tips").text("未选SKU");
				$("select[name='skuKey']").parents(".skuInfo").find(".validate_tips").addClass("valid_fail_text");
				return false;
			}
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
            	action="<%=cpath %>/vcodeActivity/doVcodeActivityAdd.do?menuType=activity">
            	<input type="hidden" name="companyKey" value="${companyKey}" />
            	<input type="hidden" name="activityType" value="${activityType}" />
            	<input type="hidden" name="randomVpointsFlag" value="1" />
                		...
                		<table class="active_board_table">
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="vcodeActivityName" tag="validate"
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
                                        ...
                                        <input name="startDate" class="form-control input-width-medium Wdate preTime"
                                       		tag="validate" autocomplete="off" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'%y-%M-%d'})" />
                                       	<span class="blocker en-larger">至</span>
                                       	<input name="endDate" class="form-control input-width-medium Wdate sufTime"
                                       		tag="validate" autocomplete="off" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'%y-%M-%d'})" />
                                       	<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
	                       	...
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content skuInfo">
	                       				<select class="form-control input-width-larger" name="skuKey">
	                    	...
	                    	<!-- <tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="guideLink" tag="validate"
	                       					class="form-control required" autocomplete="off" maxlength="200" />
	                       				<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
                	...
                	<div class="widget-content panel no-padding">
                		<table class="active_board_table">
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio isMoreSweepO" name="isMoreSweep" value="0" checked="checked" style="float:left; cursor: pointer;" />
                                        <span class="blocker en-larger">否</span>
                                        <input type="radio" class="tab-radio isMoreSweepT" name="isMoreSweep" value="1" style="float:left; cursor: pointer;" />
                            ...
                            <tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<span class="blocker">从</span>
                                        <input name="sDate" class="form-control input-width-medium Wdate required preTime"
                                       		tag="validate" autocomplete="off" disabled="disabled"
                                       		onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'%y-%M-%d'})" />
                                       	<span class="blocker en-larger">至</span>
                                       	<input name="eDate" class="form-control input-width-medium Wdate required sufTime"
                                       		tag="validate" autocomplete="off" disabled="disabled"
                                       		onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'%y-%M-%d'})" />
	                       	...
	                       	<tr>
                                ...
                                <td class="ab_main">
                                    <div class="content">
                                        <span class="blocker">从</span>
                                        <input name="sTime" class="form-control input-width-medium Wdate required"
                                                tag="validate" autocomplete="off" disabled="disabled" onfocus="WdatePicker({dateFmt:'HH:mm:ss'})" />
                                        <span class="blocker en-larger">至</span>
                                        <input name="eTime" class="form-control input-width-medium Wdate required" 
                                                tag="validate" autocomplete="off" disabled="disabled" onfocus="WdatePicker({dateFmt:'HH:mm:ss'})" />
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="validCount" tag="validate" class="form-control number positive" autocomplete="off" maxlength="1" style="width: 240px;" value= "1" readonly="readonly"/>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                	...
                	<div class="widget-content panel no-padding">
                		<table class="active_board_table">
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio firstRadioMoney" name="firstRebateType" value="0" checked="checked" style="float:left; cursor: pointer;" />
                                        <span class="blocker en-larger">金额</span>
                                        <input type="radio" class="tab-radio firstRadioScore" name="firstRebateType" value="1" style="float:left; cursor: pointer;" />
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content firstRebate">
	                       				<span class="blocker">从</span>
	                       				<input id="firstRebateMin" name="firstRebateMin" tag="validate"
	                       					class="form-control money preValue maxValue input-width-small" autocomplete="off" maxlength="5" maxVal="99" />
	                       				<span class="blocker en-larger">至</span>
	                       				<input id="firstRebateMax" name="firstRebateMax" tag="validate"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="firstRebateReserver" class="form-control" autocomplete="off" maxlength="150" style="width: 380px;"/>
                            ...
                            <tr>
                                ...
                                <td class="ab_main">
                                    <div class="content">
                                        <div class="content">
                                        	<textarea rows="3" cols="50" name="dotRuleInfo" style="width: 480px;"></textarea>
                        				</div>
                	...
                	<div class="widget-content panel no-padding">
                		<table class="active_board_table">
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				...
	                       				<input name="sameMinuteRestrict" tag="validate" mark="blacklist"
	                       					class="form-control number positive input-width-small rule" autocomplete="off" maxlength="4" />
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio doubtRadioMoney" name="doubtRebateType" value="0" checked="checked" style="float:left; cursor: pointer;" />
                                        <span class="blocker en-larger">金额</span>
                                        <input type="radio" class="tab-radio doubtRadioScore" name="doubtRebateType" value="1" style="float:left; cursor: pointer;" />
                                        <span class="blocker en-larger">积分</span>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
