  ...
  <head>
	...
	<script>
		...
		function initPage() {
			...
			// 优惠券类型变化时，中出方式的展示
			/*$(".js-select-category-list").change(function() {
				if ($(this).val() === 'f1aeda85-f385-11ed-91fa-46ef71ea4d78') {
					$(".js-select-ticket-limit").val('0');
					$(".js-select-ticket-limit").attr('disabled', 'disabled');
				} else {
					$(".js-select-ticket-limit").val('');
					$(".js-select-ticket-limit").removeAttr('disabled');
				}
				if($('[name="ticketLimit"]').val()=='0' || !$('[name="ticketLimit"]').val()){
					$(".ticketLimitNum").hide();
				}else{
					$(".ticketLimitNum").show();
				}
    ...
    <div class="row mart20">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
            	action="<%=cpath %>/vcodeTicketActivity/doTicketActivityAdd.do">
                		...
                		<table class="active_board_table">
                			...
                			<tr>
	                       	...
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content firstRebate">
	                       				<select class="form-control input-width-larger required js-select-category-list" tag="validate" name="categoryKey">
	                       	...
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content firstRebate">
	                       				<select class="form-control input-width-medium js-select-ticket-limit" tag="validate" name="ticketLimit">
										...
										<input name="ticketLimitNum" tag="validate"
											   class="form-control required input-width-small positive ticketLimitNum " autocomplete="off" maxlength="11" />
                            ...
                            <tr>
                                ...
                                <td class="ab_main">
                                    <div class="content">
                                        <div class="content">
                                        	<textarea tag="validate" rows="5" class="form-control required" autocomplete="off" name="activityDesc" maxlength="500"></textarea>
                                       		<label class="validate_tips"></label>
                        				</div>
                                    </div>
                                </td>
