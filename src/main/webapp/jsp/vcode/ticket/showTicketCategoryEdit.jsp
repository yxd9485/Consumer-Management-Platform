...
<head>
    ...
    <script>
        ...
        function initPage() {
            ...
            var imgData = '${ticketCategory.categoryPicUrl}';
            if (imgData) {
                showImg(imgData);
            }
            ...
            $("[name='prizeExpireType']").on("change", function () {
                if ($(this).val() == '0') {
                    $(this).closest("div").find("input[name='startDate']").removeAttr("disabled");
                    ...
                    $(this).closest("div").find("input[name='startDate']").attr("disabled", "disabled").val("");
...
<div class="container">
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li class="current"><a title="">优惠券类型配置</a></li>
            <li class="current"><a title="">修改优惠券类型</a></li>
        </ul>
    </div>
    <div class="row mart20">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath %>/vpsVcodeTicketDenomination/doTicketCategoryEdit.do">
                ...
                <div class="widget box">
                    ...
                    <div class="widget-content panel no-padding">
                        ...
                        <table class="active_board_table">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name=categoryType tag="validate"
                                               ...
                                               value="${ticketCategory.categoryType}"/>
                                        <input name=categoryKey tag="validate"
                                               class="form-control required" autocomplete="off" maxlength="30"
                                               value="${ticketCategory.categoryKey}"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="ab_left"><label class="title">优惠券类型名称：<span class="required">*</span></label>
                                </td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                            ...
                            <tr>
                                <td class="ab_left"><label class="title">小程序id：<span class="required"></span></label>
                                </td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="jumpId" tag="validate"
                                               class="form-control" autocomplete="off" maxlength="100"
                                               value="${ticketCategory.jumpId}">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="ab_left"><label class="title">描述：<span class="required">*</span></label>
                                </td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="categoryDesc" tag="validate"
                                               class="form-control required" autocomplete="off" maxlength="100"
                                               value="${ticketCategory.categoryDesc}">
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                            <tr style="height: 60px;">
                                <td class="ab_left"><label class="title">优惠券图片上传：<span class="white">*</span><br/></label>
                                </td>
                                <td class="ab_main" colspan="3">
