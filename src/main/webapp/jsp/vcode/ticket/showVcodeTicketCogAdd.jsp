	...
	<script>
		...
		function initPage() {
            ...
            $("[name='ticketType']").change(function(){
            	if ($(this).val() == "1") {
            		$("tr.ticketCodeFile").css("display", "");
            	} else {
            		$("tr.ticketCodeFile").css("display", "none");
            	}
            });
		}
		...
		function validForm() {
			...
			if ($("[name='ticketType']:checked").val() == "1" && $("[name='filePath']").val() == "") {
				$.fn.alert("请选择要导入的券码文件");
				return false;
			}
                		...
                		<table class="active_board_table">
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
		                       		<div class="content">
		                       			<input type="radio" class="tab-radio" name="ticketType" checked="checked" value="0" style="float:left;" />
	                       				<span class="blocker en-larger" style="padding-right: 8px;">链接</span>
		                       			<input type="radio" class="tab-radio" name="ticketType" value="1" style="float:left; margin-left: 5px;" />
                            ...
                            <tr>
                                ...
                                <td class="ab_main">
                                    <div class="content">
                                        <div class="content">
                                        	<textarea rows="5" class="form-control required" autocomplete="off" id="ticketDesc" name="ticketDesc" ></textarea>
                                       		<label class="validate_tips"></label>
                        				</div>
                                    </div>
                                </td>
                            </tr>
                			<tr class="ticketCodeFile" style="display:none;">
