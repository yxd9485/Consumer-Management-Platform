            	...
            	<div class="widget box">
                	...
                	<div class="widget-content panel no-padding">
                		<table class="active_board_table">
                        		...
                        		<td class="ab_main perItem">
                        			<c:forEach items="${fn:split(perhundredCog.perItems,';')}" var="item" varStatus="idx">
	                        			<div class="content perItem" style="margin: 5px 0px;">
	                                         <input name="perItem" class="form-control number positive input-width-small rule" autocomplete="off" maxlength="9" value="${fn:split(item,':')[0]}" onfocus="clearInput(this,'1')" onblur="inspectValueType(this, '1')"/>
	                                         <span class="blocker en-larger">金额</span>
	                                         <input name="moneys" class="form-control moneys input-width-small rule" autocomplete="off" maxlength="6" value="${fn:split(item,':')[1]}"  onfocus="clearInput(this,'2')" onblur="inspectValueType(this, '2')"/>
	                                         <span class="blocker en-larger">积分</span>
	                                         <input name="vpoints" class="form-control number positive input-width-small rule" autocomplete="off" maxlength="3" value="${fn:split(item,':')[2]}" onfocus="clearInput(this,'1')" onblur="inspectValueType(this, '1')"/>
	                       				...
	                       				<select class="form-control input-width-larger" disabled="disabled" id="vcodeActivityKey" name="vcodeActivityKey">
	                       					...
	                       					<c:forEach items="${activityList }" var="activity">
	                       						<option value="${activity.vcodeActivityKey }@${activity.skuName }@${activity.skuType }" 
	                       							<c:if test="${perhundredCog.vcodeActivityKey eq activity.vcodeActivityKey}">selected</c:if>>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
									    <input name="status" type="hidden" value=${perhundredCog.status } />
									    <input id="status" type="checkbox" data-size="small" data-on-text="启用" data-off-text="停用" data-on-color="success" 
									    data-off-color="warning" <c:if test="${perhundredCog.status eq '1'}"> checked </c:if>/>
                                    </div>
                                </td>
                            </tr>
                		</table>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="restrictVpoints" tag="validate" value="${perhundredCog.restrictVpoints eq 0 ? '' : perhundredCog.restrictVpoints}" 
                                            class="form-control number positive input-width-small rule" autocomplete="off" maxlength="9" />
                                        <span class="blocker en-larger">积分</span>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="restrictMoney" tag="validate" value="${perhundredCog.restrictMoney eq 0.00 ? '' : perhundredCog.restrictMoney}"
	                       					class="form-control number money input-width-small rule" autocomplete="off" maxlength="9"  onblur="inspectValueType(this,'2')"/>
                    ...
                    <div class="active_table_submit mart20">
                        <div class="button_place">
                        	<c:if test="${perhundredCog.isBegin ne '2'}">
