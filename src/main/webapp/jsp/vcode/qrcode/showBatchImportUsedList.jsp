    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <div class="widget box">
	            <div class="row">
	               <div class="col-md-2"><span style="font-size: 15px; color: white; font-weight: bold;">已使用码源查询</span></div>
	            ...
	            <div class="widget-content form-inline">
		            <form class="listForm" method="post"
	                    action="<%=cpath%>/qrcodeBatchInfo/showBatchImportUsedList.do">
			            ...
			            <div class="col-md-12 ">
		                    <div class="form-group little_distance search" style="line-height: 35px;">
		                        ...
		                        <div class="search-item">
			                        ...
			                        <input name="activityNo" class="form-control input-width-larger" autocomplete="off" maxlength="30"/>
		                        </div>
                                <div class="search-item">
            ...
            <div class="widget box" id="tab_1_1">
                <div class="row">
                   <div class="col-md-2"><span style="font-size: 15px; color: white; font-weight: bold;">已使用码源列表</span></div>
                </div>
                <div class="widget-content">
                    <div role="grid" class="dataTables_wrapper form-inline" id="DataTables_Table_0_wrapper">
                        <table class="table table-checkable table-striped table-hover table-bordered plus_end plus_top dt_table mart10"
                               id="dataTable_data">
                            <input type="hidden" id="screenWidth1366" value="5,5,10,10,8,13,8,10,13,8,9,8" />
                            <thead>
                                <tr>
                                    <th style="width:3%;"><input type="checkbox" name="allCB" id="allCB" /></th>
                                    <th style="width:3%;">序号</th>
                                    <th style="width:8%;" data-ordercol="o.order_no">码源订单编号</th>
                                    <th style="width:10%;" data-ordercol="b.client_order_no">客户订单编号</th>
                                    <th style="width:6%;" data-ordercol="b.batch_no">导入批号</th>
                                    <th style="width:12%;" data-ordercol="b.batch_name">批码编号/名称</th>
                                    <th style="width:6%;" data-ordercol="(b.qrcode_amounts * b.pack_amounts)">码数量</th>
                                    <th style="width:8%;" data-ordercol="b.start_date">批码有效期</th>
                                    <th style="width:12%;" data-ordercol="acg.vcode_activity_name">活动编号/名称</th>
                                    <th style="width:9%;" data-ordercol="b.activate_phone">激活人</th>
					        ...
					        <tbody>
					        	...
					        	<tr>
                                   <td style="text-align:center;">
                                    ...
                                    <td title="${item.activityNo}" class="dblclick">
            ...
            <div class="modal-content" style="top:20%;">
                ...
                <div class="modal-body">
                    <table class="active_board_table" style="line-height: 30px;">
                        <tr>
                            <td width="25%" class="text-right"><label class="title" style="margin-bottom: 0px;">客户订单编号：<span class="required">&nbsp;</span></label></td>
                            <td>
                                <div class="content">
