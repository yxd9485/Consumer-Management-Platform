	...
	<script>
		...
		function initPage() {
			...
			$(".btnSave").click(function(){
                ...
                $("input[name='shareAwardType']:checked").each(function(i){
                    if ($(this).val() == '0') {
                        ...
                        console.log(totalNewUserPrizePercent)
                    ...
                    if ($(this).val() == '1') {
                        ...
                        console.log(totalOldUserPrizePercent)
            ...
            $("input[name='shareType']").change(function(){
                console.log("shareType",$("input[name='shareType']:checked").val())
                ...
                if(shareType=='0'){
                    ...
                    $(".numberLimitTr").show();
                    $(".newtaskCompletionLimit").css("display", "none");
                    $("#taskCompletionLimitDay").val("");
                ...
                if(shareType=='3'){
                    ...
                    $(".newtaskCompletionLimit").show();
                    $(".newtaskCompletionLimitDate").css("display", "none");
    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
            	action="<%=cpath %>/activateRedEnvelopeRuleCog/saveActivityCog.do">
            	...
            	<div class="widget box">
            		<div class="widget-header">
            			<h4><i class="iconfont icon-xinxi"></i>新增活动</h4>
            		</div>
                		...
                		<table class="active_board_table">
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="ruleName" tag="validate"
                			...
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
                                        ...
                                        <input name="startDate" id="startDate" class="form-control input-width-medium Wdate required "
                                            tag="validate" autocomplete="off" onfocus="WdatePicker({realDateFmt:'yyyy-MM-dd HH:mm:ss'})"  />
                                        <span class="blocker en-larger">至</span>
                                        <input name="endDate" id="endDate" class="form-control input-width-medium Wdate required "
                                            tag="validate" autocomplete="off" onfocus="WdatePicker({realDateFmt:'yyyy-MM-dd HH:mm:ss'})" />
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" name="shareType" value="1" style="float: left;  margin-top: 12px; cursor: pointer;"  checked > <span class="blocker en-larger" style="margin-left: 2px;">二维码分享</span>
                                        <input type="radio" name="shareType" value="0" style="float: left;  margin-top: 12px; cursor: pointer;"  ><span class="blocker en-larger" style="margin-left: 2px;"> 海报分享（B激活给予A奖励）</span>
                                        <input type="radio" name="shareType" value="3" style="float: left;  margin-top: 12px; cursor: pointer;"  ><span class="blocker en-larger" style="margin-left: 2px;"> 海报分享（B激活给予A待激活红包）</span>
<%--                                        <input type="radio" name="shareType" value="2" style="float: left;  margin-top: 12px; cursor: pointer;"  checked ><span class="blocker en-larger" style="margin-left: 2px;"> 海报、二维码同时分享</span>--%>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="shareFlag" type="hidden" value="1" />
                                        <input id="shareFlag" type="checkbox" checked data-size="small" data-on-text="开" data-off-text="关" data-on-color="info" data-off-color="danger"/>
                                    </div>
                                    <label class="blocker en-larger">（开关开启后用户可以通过按钮分享给好友）</label>
                                </td>
                            </tr>
                            <tr id="newUserTypeTr" style="display: none">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <input type="radio" name="newUserType" value="2" style="float: left;  margin-top: 12px; cursor: pointer;"  >
                                        <input id="newUserAsk" name="newUserAsk" tag="validate" disabled class="form-control-small required maxValue"  data-oldval="" maxVal="999" autocomplete="off" maxlength="6" style="float: left;  margin-top: 8px; cursor: pointer;"/>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="userRewardFlag" type="hidden" value="1" />
                                        <input id="userRewardFlag" type="checkbox" checked data-size="small" data-on-text="开" data-off-text="关" data-on-color="info" data-off-color="danger"/>
                                    </div>

                                <label class="blocker en-larger">（开关开启后被分享的用户完成扫码任务后分享者可得积分红包）</label>
                                </td>
                            </tr>
                            ...
                            <tr class="shareRewardCogTr">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="show_content content">
                                        ...
                                        <input id = "moneyRegionMin" name="moneyRegion"   value="0.00" tag="validate"
                                               class="form-control  preValue money minValue maxValue input-width-small  moneyRegion " style="float:left;" autocomplete="off" minVal="0" maxlength="10" />
                                        <label class="blocker en-larger">元</label>
                                        <span class="blocker en-larger">-</span>
                                        <input id = "moneyRegionMax" name="moneyRegion"   value="0.00" tag="validate"
                                               class="form-control sufValue money minValue maxValue input-width-small  moneyRegion " style="float:left;"  autocomplete="off" minVal="0" maxlength="10" />
                                        <label class="blocker en-larger">元</label>
                                        <label class="validate_tips"></label>
                                    </div>
                            ...
                            <tr class="shareRewardCogTr">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="show_content content">
                                        ...
                                        <input id = "pointRegionMin" name="pointRegion"   value="0"
                                               class="form-control input-width-small number integer  preValue minValue maxValue pointRegion" style="float:left;" minVal="0" maxVal="9999"  autocomplete="off" maxlength="10" tag="validate"/>
                                        <label class="blocker en-larger">积分</label>
                                        <span class="blocker en-larger">-</span>
                                        <input id ="pointRegionMax" name="pointRegion"   value="0"
                                               class="form-control input-width-small number integer  sufValue minValue maxValue pointRegion" style="float:left;" minVal="0" maxVal="9999" autocomplete="off" maxlength="10" tag="validate"/>
                                        <label class="blocker en-larger">积分</label>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                            <tr class="shareAwardCogTr shareAwardTypeCogTr" style="display: none">
                                <td class="ab_left"><label class="title"> 分享者激励：<span class="required">*</span></label></td>
                                <td class="ab_main" colspan="3">
                                    <div style="float: left; margin-right: 10px;">
                                        <input name="shareAwardType" value="0" type="checkbox" tag="validate" style="float: left;  margin-top: 12px; cursor: pointer;"><span class="blocker en-larger" style="margin-left: 2px;"> 分享给新用户</span>
                                    </div>
                                </td>
                            </tr>

                            <tr class="shareAwardCogTr newUserPrizeCog" style="display: none">
                                <td class="ab_main" colspan="3">
                            ...
                            <tr class="shareAwardCogTr shareAwardTypeCogTr" style="display: none">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div style="float: left; margin-right: 10px;">
                                        <input name="shareAwardType"  value="1" type="checkbox" tag="validate" style="float: left;  margin-top: 12px; cursor: pointer;"><span class="blocker en-larger" style="margin-left: 2px;"> 分享给老用户</span>
                                    </div>
                                </td>
                            </tr>

                            <tr class="shareAwardCogTr oldUserPrizeCog" style="display: none">
                                <td class="ab_main" colspan="3">
                            ...
                            <tr class="shareNewUserAwardCogTr" style="display: none">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="show_content content">
                                        ...
                                        <input id = "acceptShareNewUserMinMoney" name="acceptShareNewUserMinMoney"   value="" tag="validate"
                                        ...
                                        <label class="blocker en-larger">元</label>
                                        <span class="blocker en-larger">-</span>
                                        <input id = "acceptShareNewUserMaxMoney" name="acceptShareNewUserMaxMoney"   value="" tag="validate"
                            ...
                            <tr id="officialAccountFlagTr">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="officialAccountFlag" type="hidden" value="1" />
                                        <input id="officialAccountFlag" type="checkbox" checked data-size="small" data-on-text="开" data-off-text="关" data-on-color="info" data-off-color="danger"/>
                                    </div>
                            ...
                            <tr class="rewardReceiveLimitTr">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <input name="rewardReceiveLimit" value="0"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="sharerGetRewardLimit" value="0"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="receiveNumber" value="10"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="receiveTimeLimit" value="5"
                                               class="form-control input-width-larger integer required" autocomplete="off" maxlength="5" tag="validate"/>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="cashPrize" value="0"
                                               style="float:left; margin-left: 20px !important;"  checked="checked"/>
                                        <span class="blocker en-larger" style="margin-left: 2px;">中出后有效天数</span>
                                        <input name="taskCompletionTimeLimit" id="taskCompletionTimeLimit" maxVal="365" data-oldval=""
                                               placeholder="0表示不限制" tag="validate"
                                               class="form-control input-width-larger required maxValue" autocomplete="off"/>
                                        <input type="radio" class="tab-radio newtaskCompletionLimit" name="cashPrize" value="1"
                                               style="float:left;display: none"/>
                                        <span class="blocker en-larger newtaskCompletionLimit " style="margin-left: 2px;display: none">固定截止时间</span>
                                        <input name="taskCompletionLimitDay" id="taskCompletionLimitDay"
                                               class="form-control input-width-medium Wdate required preTime newtaskCompletionLimit newtaskCompletionLimitDate"
                                               tag="validate" style="width: 180px !important;display:none;" autocomplete="off"
                            ...
                            <tr>
                                <td class="abt_left"><label id="userReceiveNumberLimitTitle" class="title">每个被分享者领取待激活总次数上限:<span class="required">*</span></label></td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="userReceiveNumberLimit" value="5"
                                               class="form-control input-width-larger integer required" autocomplete="off"  maxlength="5" tag="validate"/>
                            ...
                            <tr style="display: none" class="userReceiveNumberDayLimitTr">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="userReceiveNumberDayLimit" value="5"
                                               class="form-control input-width-larger integer required" autocomplete="off"  maxlength="5" tag="validate"/>
                            ...
                            <tr id="shareVcodeActivityTr">
                                ...
                                <td class="ab_main sku" colspan="3">
                                    <div class="content sku promotionSku" style="display: flex; margin: 5px 0px;">
                                        <select class="form-control input-width-larger required " id="shareVcodeActivityKey" name="shareVcodeActivityKey" tag="validate">
                            ...
                            <tr class="activityRuleTr" style="display: none">
                                <td class="ab_left"><label class="title">活动规则：<span class="white"></span></label></td>
                                <td class="ab_main" colspan="3">
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="stateFlag" type="hidden" value="0" />
                                        <input id="stateFlag" type="checkbox" disabled="disabled"  data-size="small" data-on-text="启用" data-off-text="停用" data-on-color="success" data-off-color="warning"/>
                                    </div>
                                    <span>（请配置中出规则后，再修改此状态）</span></br>
                                    <span>（停用期间不可分享和不中出积分红包，已领取的可以完成任务，停用期间扫的二维码启用后也不可分享）</span>
                                </td>
                            </tr>
...
<%--                            </tr>--%>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="moneyLimit"   value="0.00"
                                            class="form-control input-width-larger  number money preValue minValue maxValue required" autocomplete="off" minval="0" maxVal="999999999.99" min="0" maxlength="12" tag="validate"/>
                            ...
                            <tr class="rickUserLimit" style="display: none">
                                <td class="ab_left"><label class="title"> </label></td>
                                <td class="ab_main" colspan="3">
                                    <div class="show_content content">
                                        <span class="blocker en-larger">风险用户待激活:<span style="color: red" class="required">*</span></span>
                                        <input id = "riskUserLimitMinMoney" name="riskUserLimitMinMoney"  tag="validate"
                                               class="form-control  preValue money minValue maxValue input-width-small  moneyRegion required" style="float:left;" autocomplete="off" minVal="0.01" maxVal="9999.99" maxlength="7" />
                                        <label class="blocker en-larger">元</label>
                                        <span class="blocker en-larger">-</span>
                                        <input id = "riskUserLimitMaxMoney;" name="riskUserLimitMaxMoney"  tag="validate"
                                               class="form-control sufValue money minValue maxValue input-width-small  moneyRegion required" style="float:left;"  autocomplete="off" minVal="0.01" maxVal="9999.99" maxlength="7" />
                                        <label class="blocker en-larger">元</label>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            ...
                            <tr class="numberLimitTr">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="sharePointLimit"   value="0"
                            ...
                            <tr class="numberLimitTr">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="numberLimit"   value="0"
