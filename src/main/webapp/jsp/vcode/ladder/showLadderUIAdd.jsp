    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                  action="<%=cpath %>/ladderUI/doLadderUIAdd.do">
                        ...
                        <table class="active_board_table">
                            <tr>
                                ...
                                <td class="ab_main" colspan="2" style="width:45% !important;">
                                    <div class="content">
                                        <select name="ladderType" id="ladderType" class="form-control input-width-larger search" autocomplete="off" >
                                            <option value="0">按倍数中出</option>
                                            <option value="1">按支数中出</option>
                                        </select>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="2" style="width:45% !important;">
                                    <div class="content">
                                        <input name="ladderMultiple" id="ladderMultiple" tag="validate" autocomplete="off" maxlength="10" style="width:250px;"/>
                                        <input name="ladderStNum" id="ladderStNum" tag="validate"
                                        ...
                                        <input name="ladderEndNum" id="ladderEndNum" tag="validate"
                                               class="form-control required" autocomplete="off" maxlength="10" style="width:250px; display: none"/>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="ab_left"><label class="title">阶梯弹窗：<span class="white">*</span></label>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <div class="item">
                                            ...
                                            <input type="hidden" name="ladderPic">
                                        </div>
