    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
            	action="<%=cpath %>/doubleprize/doDoublePrizeAdd.do">
                	...
                	<div class="widget-content panel no-padding">
                		<table class="active_board_table">
                            ...
                            <tr class="lotteryScanNum">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="periodType" value="2" style="float:left; " checked="checked" />
                                        <span class="blocker en-larger" style="margin-left: 2px;">自然天</span>
                                        <input type="radio" class="tab-radio" name="periodType" value="0" style="float:left;" />
                                        <span class="blocker en-larger" style="margin-left: 2px;">自然周</span>
                                        <input type="radio" class="tab-radio" name="periodType" value="1" style="float:left;" />
                                        <span class="blocker en-larger" style="margin-left: 2px;">自然月</span>
                                        <input type="radio" class="tab-radio" name="periodType" value="3" style="float:left;" />
                            ...
                            <tr>
                                <input type="hidden" name="prizeLimit" />
                                ...
                                <td class="ab_main prize" colspan="3">
                                    <div class="content prize" style="display: flex; margin: 5px 0px;">
                                        <select class="form-control input-width-larger required" tag="validate">
                                            ...
                                            <option value="${prize.key}">${prize.value}</option>
                                            </c:forEach>
                                            </c:if>
                                        </select>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="everyoneLimit" value="1"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="everyDayLimit" value="1"
                                            class="form-control input-width-larger positive required" autocomplete="off" maxlength="10" tag="validate"/>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="activitySummaryTitle" 
                	...
                	<div class="widget-content panel no-padding filteruser">
                		<table class="active_board_table">
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="filterType" value="0" style="float:left;" checked="checked"/>
                                        <span class="blocker en-larger" style="margin-left: 2px;">过往用户</span>
                                        <input type="radio" class="tab-radio" name="filterType" value="1" style="float:left;" />
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <span class="blocker">从</span>
                                        <input name="filterStartDate" class="form-control input-width-medium Wdate required preTime"
                                           tag="validate" autocomplete="off" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', maxDate:'%y-%M-%d'})" />
                                        <span class="blocker en-larger">至</span>
                                        <input name="filterEndDate" class="form-control input-width-medium Wdate required sufTime"
                                            tag="validate" autocomplete="off" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', maxDate:'%y-%M-%d'})" />
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
