    ...
    <div class="row">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form"
                ...
                <input type="hidden" name="lotteryMoney" value="${doublePrizeCog.lotteryType}"/>
                    ...
                    <div class="widget-content panel no-padding">
                        <table class="active_board_table">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="activityName" tag="validate" value="${doublePrizeCog.activityName}"
                                            class="form-control required" autocomplete="off" maxlength="200" disabled="disabled" />
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <input name="endDate" id="endDate" class="form-control input-width-medium Wdate required sufTime" value="${doublePrizeCog.endDate}"
                                            tag="validate" autocomplete="off" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'#F{$dp.$D(\'startDate\')}'})" disabled="disabled" />
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td class="ab_main sku" colspan="3">
                                    <c:forEach items="${doublePrizeCog.promotionSkuKeyAry}" var="itemPromSkuKey" varStatus="idx">
                                        <div class="content sku promotionSku" style="display: flex; margin: 5px 0px;">
                                            <select class="form-control input-width-larger required" name="promotionSkuKeyAry" tag="validate" disabled="disabled">
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="lotteryType" value="0" style="float:left;" checked="checked" disabled="disabled"/>
                                        <span class="blocker en-larger" style="margin-left: 2px;">按扫码次数</span>
                                        <input type="radio" class="tab-radio" name="lotteryType" value="1" style="float:left;"  disabled="disabled"/>
                            ...
                            <tr class="lotteryMoney" style="display: none;">
                                ...
                                <td class="ab_main" colspan="3">
                                    <c:forEach items="${fn:split(doublePrizeCog.lotteryMoney, ',')}" var="item">
                                        <div class="content" style="display: flex; margin: 5px 0px;">
                                            <span class="blocker en-larger">从</span>
                                            <input id="lotteryMinMoney" tag="validate" value="${fn:split(item, '-')[0]}" disabled="disabled"
                                                class="form-control input-width-small money preValue maxValue required" autocomplete="off" maxlength="5" maxVal="99"/>
                                            <span class="blocker en-larger">至</span>
                                            <input id="lotteryMaxMoney" tag="validate" value="${fn:split(item, '-')[1]}" disabled="disabled"
                                                class="form-control input-width-small money sufValue maxValue required" autocomplete="off" maxlength="5" maxVal="99"/>
                                            <label class="title mart5 btn-txt-add-red" style="font-weight: normal; margin-left: 5px;" id="addLotteryMoney">新增</label>
                                            <label class="validate_tips"></label>
                                        </div>
                                    </c:forEach>
                                </td>
                            ...
                            <tr class="lotteryScanNum">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="periodType" value="2" style="float:left;" <c:if test="${doublePrizeCog.periodType eq '2'}">checked</c:if> disabled="disabled" />
                                        <span class="blocker en-larger" style="margin-left: 2px;">自然天</span>
                                        <input type="radio" class="tab-radio" name="periodType" value="0" style="float:left;" <c:if test="${doublePrizeCog.periodType eq '0'}">checked</c:if> disabled="disabled" />
                                        <span class="blocker en-larger" style="margin-left: 2px;">自然周</span>
                                        <input type="radio" class="tab-radio" name="periodType" value="1" style="float:left;" <c:if test="${doublePrizeCog.periodType eq '1'}">checked</c:if> disabled="disabled" />
                                        <span class="blocker en-larger" style="margin-left: 2px;">自然月</span>
                                        <input type="radio" class="tab-radio" name="periodType" value="3" style="float:left;" <c:if test="${doublePrizeCog.periodType eq '3'}">checked</c:if> disabled="disabled" />
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <select name="subscribeStatus" class="form-control input-width-larger" disabled="disabled">
                            ...
                            <tr>
                                <input type="hidden" name="prizeLimit" value="${doublePrizeCog.prizeLimit}" disabled="disabled"/>
                                ...
                                <td class="ab_main prize" colspan="3">
                                    <c:forEach items="${prizeLimitAry}" var="prizeKey" varStatus="idx">
                                        <div class="content prize" style="display: flex; margin: 5px 0px;">
                                            <select class="form-control input-width-larger required" tag="validate" disabled="disabled">
                            ...
                            <tr class="lotteryScanNum">
                                <td class="ab_left"><label class="title">中奖时扫码金额区间：<span class="white">*</span></label></td>
                                <td class="ab_main" colspan="3">
                                    <div class="content moneyRange">
                                        <span class="blocker en-larger">从</span>
                                        <input name="minMoney" tag="validate" value="${doublePrizeCog.minMoney}" disabled="disabled"
                                            class="form-control money preValue maxValue input-width-small" autocomplete="off" maxlength="5" maxVal="99"/>
                                        <span class="blocker en-larger">至</span>
                                        <input name="maxMoney" tag="validate" value="${doublePrizeCog.maxMoney}" disabled="disabled"
                            ...
                            <tr>
                                <td class="ab_left"><label id="everyonePeriodLimit" class="title">每人中奖次数上限：<span class="required">*</span></label></td>
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="everyoneLimit" value="${doublePrizeCog.everyoneLimit}" disabled="disabled"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="everyDayLimit" value="${doublePrizeCog.everyDayLimit}" disabled="disabled"
                                            class="form-control input-width-larger positive required" autocomplete="off" maxlength="10" tag="validate"/>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
...
<!--                             兑奖截止日期使用奖项的配置 -->
                            <tr style="display: none;">
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="prizeExpireDate" class="form-control input-width-medium Wdate required" value="${doublePrizeCog.prizeExpireDate}"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="activitySummaryTitle" value="${doublePrizeCog.activitySummaryTitle}" disabled="disabled"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <textarea name="activitySummary" rows="5" tag="validate" disabled="disabled"
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <textarea name="activityDesc" rows="5" tag="validate" disabled="disabled"
                    ...
                    <div class="widget-content panel no-padding filteruser">
                        <table class="active_board_table">
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input type="radio" class="tab-radio" name="filterType" value="0" style="float:left;" <c:if test="${doublePrizeCog.filterType eq '0'}">checked</c:if> disabled="disabled"/>
                                        <span class="blocker en-larger" style="margin-left: 2px;">过往用户</span>
                                        <input type="radio" class="tab-radio" name="filterType" value="1" style="float:left;" <c:if test="${doublePrizeCog.filterType eq '1'}">checked</c:if> disabled="disabled"/>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        ...
                                        <input name="filterStartDate" class="form-control input-width-medium Wdate required preTime" value="${doublePrizeCog.filterStartDate}"
                                           tag="validate" autocomplete="off" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', maxDate:'%y-%M-%d'})" disabled="disabled" />
                                        <span class="blocker en-larger">至</span>
                            ...
                            <tr>
                                ...
                                <td class="ab_main area" colspan="3">
                                    <div class="area" style="display: flex; margin: 5px 0px;">
                                        <select name="provinceAry" class="zProvince form-control input-width-normal" disabled="disabled"></select>
                                        <select name="cityAry" class="zCity form-control input-width-normal" disabled="disabled"></select>
                                        <select name="countyAry" class="zDistrict form-control input-width-normal" disabled="disabled"></select>
                                ...
                                <td class="ab_main sku" colspan="3">
                                    <c:forEach items="${doublePrizeCog.filterSkuKeyAry}" var="itemFilterSkuKey" varStatus="idx">
                                        <div class="content sku filterSku" style="display: flex; margin: 5px 0px;">
                                            <select class="form-control input-width-larger required" name="filterSkuKeyAry" tag="validate" disabled="disabled">
                                                <option value="">请选择SKU</option>
                                                <c:if test="${!empty skuList}">
                                                <c:forEach items="${skuList}" var="sku">
                            ...
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <input name="filterSkuTotal" class="form-control input-width-larger positive required" 
                                                value="${doublePrizeCog.filterSkuTotal}" autocomplete="off" maxlength="10" tag="validate" disabled="disabled"/>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <select name="filterDoubtStatus" class="form-control input-width-larger" disabled="disabled">
