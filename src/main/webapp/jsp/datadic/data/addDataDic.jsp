            ...
            <div class="widget box">
                ...
                <div class="widget-content panel">
                        		...
                        		<td class="ab_main" colspan="3">
                        			<div class="content">
                        				<input name="dataId" tag="validate"
                        					class="form-control required width-200" autocomplete="off" maxlength="100" placeholder="数据key"/>
                    		...
                    		<td class="ab_main" colspan="3">
                    			<div class="content">
                    				<input name="dataValue" tag="validate"
                        					class="form-control width-300" autocomplete="off" maxlength="3072" placeholder="数据值"/>
                    				<label class="validate_tips"></label>
                    			</div>
                    		</td>
                    	</tr>
                        		...
                        		<td class="ab_main" colspan="3">
                        			<div class="content">
                        				<input name="sequenceNum" tag="validate"
                        					class="form-control required width-100 positive" autocomplete="off" maxlength="100" placeholder="排序号"/>
                        				<label class="validate_tips"></label>
                        			</div>
                        		</td>
                        	</tr>
                    		...
                    		<td class="ab_main" colspan="3">
                    			<div class="content">
                    				<input name="dataAlias" tag="validate"
                        					class="form-control width-200 positive" autocomplete="off" maxlength="100" placeholder="别名"/>
                    				<label class="validate_tips"></label>
                    			</div>
                    		</td>
                    	</tr>
                    	<tr>
                                ...
                                <td class="ab_main" colspan="3">
                                    <div class="content">
                                        <textarea class="form-control" maxlength="4000" tag="validate" autocomplete="off" name="dataExplain"></textarea>
                                        <label class="validate_tips"></label>
                                    </div>
                                </td>
                            </tr>
	            ...
	            <div class="active_table_submit mart20">
		            <div class="button_place">
						...
						<a href="<%=cpath%>/sysDataDic/dataDicList.do?vjfSessionId=${vjfSessionId}" class="btn btn-radius3">返 回</a>
		            </div>
	            </div>
            </div>
            </form>
