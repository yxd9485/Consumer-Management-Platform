	                ...
	                <div class="widget-content panel">
						<table class="active_board_table">
			               		...
			               		<td class="ab_main" colspan="3">
			               			<div class="content">
			               				<input name="categoryName" tag="validate"
			               					class="form-control input-width-large required" autocomplete="off" maxlength="100" value="${category.categoryName }" />
			               		...
			               		<td class="ab_main" colspan="3">
			               			<div class="content">
			               				<input name="categoryCode" tag="validate"
			               					class="form-control input-width-large required" autocomplete="off" maxlength="100" value="${category.categoryCode }" />
			                              	<label class="validate_tips"></label>
			               			</div>
			               		</td>
			               	</tr>
			               	...
			               	<tr>
			               		...
			               		<td class="ab_main" colspan="3">
			               			<div class="content">
			               				<input type="radio" name="dicType" value="1" <c:if test="${category.dicType=='1' }">checked="checked"</c:if> class="form-control" style="width:20px;" /><label class="star_text" style="margin-top:10px;">是</label>
			               				<input type="radio" name="dicType" value="0" <c:if test="${category.dicType=='0' }">checked="checked"</c:if> class="form-control" style="width:20px;" /><label class="star_text" style="margin-top:10px;">否</label>
			               			</div>
			               		</td>
			               	</tr>
			               		...
			               		<td class="ab_main" colspan="3">
			               			<div class="content">
			               				<select name="invoker" id="invoker" class="form-control input-width-normal">
			               					<option value="0" <c:if test="${category.invoker=='0' }">selected="selected"</c:if> >全部</option>
			               					<option value="1" <c:if test="${category.invoker=='1' }">selected="selected"</c:if> >运营</option>
			               					<option value="2" <c:if test="${category.invoker=='2' }">selected="selected"</c:if> >接口</option>
			               				</select>
			               			</div>
			               		</td>
			               	</tr>
			               	...
			               	<tr>
			               		...
			               		<td class="ab_main" colspan="3">
			               			<div class="content">
			               				<input name="categoryExplain" class="form-control" maxlength="256" value="${category.categoryExplain}"/>
			               			</div>
			               		</td>
			               	</tr>
