  ...
  <head>
	...
	$(document).ready(function () {
		...
		$("#seckillType").change(function(){
			var seckillType=document.getElementById("seckillType").value;
			if(seckillType==1){
				$('#seckillTimeSet').attr("disabled",false);
				$('#seckillTimeSet').val("00:00:00,01:00:00#02:30:00,02:35:00");
				$("input[name='seckillDateType'][value=2]").prop("checked",true);
				$("input[name='userLimitType'][value=2]").prop("checked",true);
				$("input:radio[name='seckillDateType']").attr("disabled","disabled");
				$("input:radio[name='userLimitType']").attr("disabled","disabled");
			}else if(seckillType==2){
				$('#seckillTimeSet').val("");
				$('#seckillTimeSet').attr("disabled",true);
				$("input[name='seckillDateType'][value=1]").prop("checked",true);
				$("input[name='userLimitType'][value=2]").prop("checked",true);
				$("input:radio[name='seckillDateType']").attr("disabled","disabled");
				$("input:radio[name='userLimitType']").attr("disabled","disabled");
			}else if(seckillType==3){
				$('#seckillTimeSet').val("");
				$('#seckillTimeSet').attr("disabled",true);
				$("input[name='seckillDateType'][value=1]").prop("checked",true);
				$("input[name='userLimitType'][value=1]").prop("checked",true);
				$("input:radio[name='seckillDateType']").attr("disabled","disabled");
				$("input:radio[name='userLimitType']").attr("disabled","disabled");
			}else{
				$('#seckillTimeSet').val("00:00:00,01:00:00#02:30:00,02:35:00");
		    ...
		    $.ajax({
		        ...
		        beforeSend:appendVjfSessionId,
					...
					$(jdata).each(function(i,k){
						...
						if(i==(len-1)){
							strHtml+="<tr style='background:#FFA73C'>";
...
// 					strHtml+="</tbody>";
		...
		function validForm() {
			...
			$.ajax({
				url:'<%=cpath%>/seckill/checkName.do?seckillName='+seckillName,
				async: false,
				type: 'POST',
					beforeSend:appendVjfSessionId,
                    success: function(data){
    ...
    <div class="row mart20">
        <div class="col-md-12 tabbable tabbable-custom">
            <form method="post" class="form-horizontal row-border validate_form" id="code_form" enctype="multipart/form-data"
            	action="<%=cpath %>/seckill/addSeckil.do">
                		...
                		<table class="active_board_table">
                			<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content seckillName">
	                       				<input name="seckillName" id="seckillName" tag="validate"
	                       	...
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			...
	                       			<select name="seckillType" id="seckillType" tag="validate" class="form-control required input-width-large search" >
								    	<option value="">请选择</option>
								    	<option value="1">电视秒杀</option>
							    		<option value="2">商场秒杀</option>
							    		<option value="3">文章秒杀</option>
							    		<option value="4">红包雨秒杀</option>
								    </select>
                                       	<label class="validate_tips"></label>
	                       	...
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
		                       		<div class="content seckillStatus">
		                       			<input type="radio" name="seckillStatus" name="seckillStatus" value="1"  checked="checked" /><label>开启</label>
		                       			<input type="radio" name="seckillStatus" name="seckillStatus" value="0"/><label>关闭</label>
		                       		</div>
	                       		</td>
	                       	</tr>
                            <tr>
							...
							<tr>
	                       	...
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
		                       		<div class="content seckillDateType">
		                       			<input type="radio" name="seckillDateType" id="seckillDateType" value="1"  checked="checked"/><label>限制时间</label>
		                       			<input type="radio" name="seckillDateType" id="seckillDateType" value="2" /><label>限制时间与时间段</label>
		                       		</div>
	                       		</td>
	                       	</tr>
	                       	<tr>
	                       	...
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content seckillTimeSet">
	                       				<textarea name="seckillTimeSet" id="seckillTimeSet" tag="validate" rows="5" cols="100">00:00:00,01:00:00#02:30:00,02:35:00</textarea>
	                       				<label class="validate_tips"></label>
	                       			</div>
	                       		</td>
	                       	</tr>
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
		                       		<div class="content followScanType">
		                       			<input type="radio" name="followScanType" id="followScanType" value="1" /><label>是</label>
		                       			<input type="radio" name="followScanType" id="followScanType" value="0"  checked="checked"/><label>否</label>
		                       		</div>
	                       		</td>
	                       	</tr>
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="seckillCountLimit" tag="validate"  value="0"
	                       	...
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="seckillMoneyLimit" tag="validate"  value="0.00"
	                       	...
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
		                       		<div class="content userLimitType">
		                       			<input type="radio" name="userLimitType" id="userLimitType" value="1"  checked="checked"/><label>总个数</label>
		                       			<input type="radio" name="userLimitType" id="userLimitType" value="2" /><label>单日个数</label>
		                       			<input type="radio" name="userLimitType" id="userLimitType" value="3" /><label>单个时间段数</label>
		                       		</div>
	                       		</td>
	                       	</tr>
	                       	<tr>
	                       		...
	                       		<td class="ab_main" colspan="3">
	                       			<div class="content">
	                       				<input name="seckillUserlimit" tag="validate"  value="0"
	                       					class="form-control required integer input-width-small rule" autocomplete="off" maxlength="9" />
	                       				<span class="blocker en-larger">个</span>
	                       				<label class="validate_tips"></label>
	                       			</div>
