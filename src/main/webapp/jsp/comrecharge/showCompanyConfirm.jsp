            ...
            <div class="widget box">
	                  		...
	                  		<td class="ab_main">
	                  			<div class="content">
	                  				<input name="rechargeMoney" maxLength="10" class="payMoney form-control required money minValue maxValue"
	                  					minVal="-9999999.99" maxVal="9999999.99" tag="validate" autocomplete="off" autocomplete="off"  value="${info.rechargeMoney}"/>
                ...
                <div class="active_table_submit mart20">
                    <div class="button_place">
                        <a id="btnSubmit" href="#" class="btn btn-blue">提 交</a>&nbsp;&nbsp;&nbsp;&nbsp;
