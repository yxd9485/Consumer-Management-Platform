    ...
    <script type="text/javascript">
	    ...
	    $(function () {
            ...
            $(".button_place #btnSubmit").click(function(){
            	if (validForm()) {
            		$.fn.confirm("确定提交当前企业的充值请求吗？", function() {
                        $("form").attr("action", "<%=cpath %>/companyRecharge/doCompanyRecharge.do");
                        $("form").submit();
                    });
            	}
            });
                ...
                <div class="widget-content panel nopadding">
                    <table class="active_board_table">
                        <tr>
	                  		...
	                  		<td class="ab_main">
	                  			<div class="content">
	                  				<input name="contractNum" class="form-control required contractNum" tag="validate" maxlength="20" autocomplete="off" />
                        ...
                        <tr>
	                  		...
	                  		<td class="ab_main">
	                  			<div class="content">
	                  				<input name="contractName" class="form-control required contractName" tag="validate" maxlength="50" autocomplete="off" />
                        ...
                        <tr>
	                  		...
	                  		<td class="ab_main">
	                  			<div class="content">
	                  				<select class="form-control required" name="transType">
	                                         ...
	                                         <option value="2">第三方支付工具</option>
	                                         <option value="3">支票</option>
	                                         <option value="4">欠款代付</option>
	                                     </select>
	                  			</div>
	                  		</td>
	                  	</tr>
	                  		...
	                  		<td class="ab_main">
	                  			<div class="content">
	                  				<input name="rechargeMoney" maxLength="10" class="payMoney form-control required money minValue maxValue"
	                  					minVal="-9999999.99" maxVal="9999999.99" tag="validate" autocomplete="off" autocomplete="off" />
	                  	...
	                  	<tr style="display: none;">
	                  		...
	                  		<td class="ab_main">
	                  			<div class="content">
	                  				<input class="form-control showPoints" name="rechargeVpoints" readonly="readonly" /> <b>V分</b>
	                  			</div>
	                  		</td>
	                  	</tr>
                    </table>    
