 ...
 */
public class VpsAdShop {
//主键
private String adShopKey;
//关键词
...
public VpsAdShop(){};
public VpsAdShop(String queryParam){
   ...
   this.modEndGmt = paramAry.length > 5 ? paramAry[5] : "";
	...
	public String getAdShopKey() {
	return adShopKey;
}
public void setAdShopKey(String adShopKey) {
	this.adShopKey = adShopKey;
}
